...
pub use eml_opcode_gate::{
    admit_exp_call_sites, admit_ln_call_sites, combine_in_closed_vocabulary, exp_primitive_domain,
    ln_primitive_domain,
    ...
    EmlOperatorGadget, EntropyTermGadget, LogAccumulateMapGadget, PowerLawGadget,
