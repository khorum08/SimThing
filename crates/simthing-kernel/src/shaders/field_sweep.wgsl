...
// primitive name, never a mutation of LN. Placed OUTSIDE the JIT evaluator
// markers so the interpreted arm and every JIT-generated straight-line block
// call this one definition.
