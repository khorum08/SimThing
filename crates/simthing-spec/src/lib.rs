...
pub use compile::{
    ...
    estimate_region_field_budget, eval_eml_postfix, exact_sqrt_f_artifact_descriptor, fnv1a64_hex,
    ...
    is_sead_act0_numeric_proposals_descriptor, is_sead_act1_phase_e_proposal_consumer_descriptor,
    ...
    mag_f_from_exact_mag2_kernel_descriptor, oracle_acceleration, oracle_bounded_feedback,
    oracle_decay, oracle_ema, oracle_field_sampler, oracle_hysteresis, oracle_soft_step,
    oracle_velocity_monitor, oracle_weighted_accumulator, preview_kernel_graph_cohorts,
    ...
    reject_unknown_gadget_kind, sead_act0_numeric_proposals_kernel_descriptor,
    ...
    sead_pipe0_observer_event_pipeline_kernel_descriptor, sqrt_f_exact_kernel_descriptor,
    ...
    validate_score_authority_contract, validate_sead_act0_numeric_proposals_contract,
    validate_sead_act1_phase_e_proposal_consumer_contract,
    validate_sead_act2_proposal_admission_records_contract,
    validate_sead_act3_economic_fixture_records_contract, validate_sead_event0_compaction_contract,
    validate_sead_event1_code_bucketing_contract, validate_sead_event2_bucket_reductions_contract,
    ...
    validate_sead_pipe0_observer_event_pipeline_contract, CapabilityTreeBuildOutput,
    CapabilityTreeBuilder, CompileContext, CompiledArenaAdmission, CompiledCouplingAdmission,
    CompiledCouplingDelay, CompiledEmissionFormula, CompiledEmitOnThreshold, CompiledEmlGadget,
    CompiledEmlGadgetStack, CompiledFieldCadence, CompiledFirstSliceCommitmentDirection,
    ...
    ADMITTED_REGION_FIELD_FORMULA_CLASSES, DEFERRED_GADGET_KINDS, FIRST_SLICE_FIELD_URGENCY_COL,
    MAG2_FIXED_DESCRIPTOR_ID, MAG2_FIXED_LABEL, MAG2_Q16_COMPONENT_MAX, MAG2_Q16_FRAC_BITS,
    MAG2_Q16_SCALE, MAG2_Q16_SCALE_SQ, MAG_F_FROM_DXDY_PROBE_DESCRIPTOR_ID,
    ...
    SEAD_ACT0_CODE_COUNT, SEAD_ACT0_DESCRIPTOR_ID, SEAD_ACT0_LABEL, SEAD_ACT1_ADMITTED_TABLE_SIZE,
    SEAD_ACT1_DESCRIPTOR_ID, SEAD_ACT1_LABEL, SEAD_ACT2_ADMISSION_RECORD_STRIDE,
    SEAD_ACT2_DESCRIPTOR_ID, SEAD_ACT2_LABEL, SEAD_ACT3_DESCRIPTOR_ID,
    SEAD_ACT3_FIXTURE_RECORD_STRIDE, SEAD_ACT3_LABEL, SEAD_EVENT0_DESCRIPTOR_ID, SEAD_EVENT0_LABEL,
    SEAD_EVENT1_CODE_COUNT, SEAD_EVENT1_DESCRIPTOR_ID, SEAD_EVENT1_LABEL, SEAD_EVENT2_CODE_COUNT,
    SEAD_EVENT2_DESCRIPTOR_ID, SEAD_EVENT2_LABEL, SEAD_OBS0_DESCRIPTOR_ID, SEAD_OBS0_LABEL,
    SEAD_OBS2_DESCRIPTOR_ID, SEAD_OBS2_LABEL, SEAD_OBS2_LAYER_COUNT, SEAD_OBS3_DESCRIPTOR_ID,
    SEAD_OBS3_LABEL, SEAD_OBS3_LAYER_COUNT, SEAD_OBS4_DESCRIPTOR_ID, SEAD_OBS4_LABEL,
    SEAD_OBS4_LAYER_COUNT, SEAD_PIPE0_DESCRIPTOR_ID, SEAD_PIPE0_LABEL, SEAD_PIPE0_LAYER_COUNT,
    SQRT_F_ARTIFACT_HASH, SQRT_F_ARTIFACT_PATH, SQRT_F_DESCRIPTOR_ID, SQRT_F_DOMAIN,
    SQRT_F_ENTRYPOINT, SQRT_F_IO_CONTRACT, SQRT_F_PROOF_REPORT,
};
