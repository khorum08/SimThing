...
pub use compile::{
    ...
    mag_f_from_exact_mag2_kernel_descriptor,
    ...
    Mag2SourceContract, MAG2_FIXED_DESCRIPTOR_ID, MAG2_FIXED_LABEL, MAG2_Q16_COMPONENT_MAX,
    MAG2_Q16_FRAC_BITS, MAG2_Q16_SCALE, MAG2_Q16_SCALE_SQ,
