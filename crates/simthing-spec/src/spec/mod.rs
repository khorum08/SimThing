...
pub use scenario::{
    apply_gridcell_property_edit, apply_owner_entity_metadata, apply_scenario_metadata_to_root,
    canonical_scenario_link_key, canonical_scenario_link_pair, deserialize_scenario_authority,
    game_session_child, game_session_owners, is_owner_entity_kind, make_owner_entity,
    owner_entity_id, property_u32, reserve_simthing_ids_from_scenario, resolve_map_container,
    ...
    scenario_metadata_u32_value, serialize_scenario_authority, spatial_authority_root,
    ...
    SimThingStructuralGridPlacement, SteadMappingError, OWNER_ARCHETYPE_PROPERTY_ID,
    OWNER_COLOR_INDEX_PROPERTY_ID, OWNER_DISPLAY_NAME_PROPERTY_ID, OWNER_ID_PROPERTY_ID,
    OWNER_SILO_MARKER_PROPERTY_ID, SCENARIO_GENERATED_SYSTEM_ID_PROPERTY_ID,
