...
pub use scenario::{
    ...
    canonical_scenario_link_pair, deserialize_scenario_authority, property_u32,
    ...
    validate_legacy_world_root_compatibility, validate_scenario_links,
    validate_scenario_root_authority, validate_stead_mapping_consistency, ScenarioEditError,
