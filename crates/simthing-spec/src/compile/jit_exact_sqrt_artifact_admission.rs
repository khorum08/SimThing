...
fn has_numeric_proposal_reads(spec: &KernelDescriptorSpec) -> bool {
    spec.reads.iter().any(|read| read == "reduction_count")
        && spec.reads.iter().any(|read| read == "sum_score")
