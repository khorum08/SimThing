...
#[test]
fn runtime1_rejects_default_on_behavior() {
...
#[test]
fn runtime1_rejects_semantic_or_raw_wgsl() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_owner_as_spatial_parent() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_capture_as_reparenting() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_nested_arena_reparenting() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_default_on_resource_flow() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_hard_currency_through_resource_flow() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_hybrid_strata_or_faction_index_scaling() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_closed_ladder_reopen() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_rejects_unscoped_gpu_passgraph_wiring() {
    let mut forbidden = MobilityRuntime1aForbiddenPathRequests::default();
...
#[test]
fn runtime1_34k_production_fixture_soak() {
    let mut input = fixture_input();
    ...
    let report = run_mobility_runtime1a_production_fixture(&input);
    assert!(report.admitted, "{:?}", report.diagnostics);
