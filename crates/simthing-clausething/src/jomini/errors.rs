...
// MODIFIED: binary LexerError From impl removed.
use crate::jomini::ScalarError;
...
/// The specific reader error kind, shared by text and binary [TokenReader](crate::jomini::text::TokenReader)s.
...
/// text and binary [TokenReader](crate::jomini::text::TokenReader)s.
