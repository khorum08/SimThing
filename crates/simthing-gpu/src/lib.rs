...
pub use simthing_kernel::{
    ...
    ResidencyRelocationOutcome, ResidencySessionTermination, ResolvedWriteAuthority, ScatterEntry,
    SlotAllocError, SlotAllocator, SlotDeltaRange, SlotSummary, StructuralCommitment,
