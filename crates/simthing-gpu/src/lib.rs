...
pub use simthing_kernel::{
    ...
    FieldSweepExecutionError, FieldSweepRegistration, FieldSweepRegistrationRequest,
    FieldSweepResourceClass, FieldSweepResourceClassRequest, FieldSweepSession, GridN4Offset,
    GridOffset, LinkGraphNeighbor,
