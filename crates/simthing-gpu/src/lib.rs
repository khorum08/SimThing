...
pub use simthing_kernel::{
    ...
    band_crossing_deltas_from_fused_emissions, conjunctive_recipe_registrations_to_transfer,
    cpu_oracle_band_crossing_deltas, cpu_oracle_emission_records, cpu_oracle_threshold_events,
