...
pub use simthing_kernel::{
    ...
    emit_on_threshold_registrations_to_ops, encode_column, encode_column_rules,
    ...
    FieldRegistrationAuthority, FieldRegistrationRef, LegacyOracleFamily, LogicalRowRange,
    LogicalSubtreeDirectory, OpSetHandle, OperationFamily, OverlayCompileCache, OverlayDelta,
    OverlayDenseMaterialization, OverlayOrderBandPlan, OverlayProjectionHostChange,
