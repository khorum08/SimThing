...
pub use simthing_kernel::{
    ...
    band_crossing_updates_from_deltas,
    ...
    emit_on_threshold_registrations_to_ops, encode_anchor_table_gpu, encode_column, encode_column_rules,
    encode_emission_plan, encode_rule,
    encode_transfer_plan, eval_eml_cpu, execute_ops_cpu, execute_threshold_ops_cpu,
    governed_pairs_for_property, oracle_anchor_table_after_deltas, plan_emission_ops, plan_governed_integration,
    ...
    AoWgsl0FallbackReason, AoWgsl0PlanShape, AnchorTableRowGpu, BandCrossingDelta, BandCrossingDirection,
