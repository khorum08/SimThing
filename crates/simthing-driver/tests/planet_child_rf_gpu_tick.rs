...
#[test]
fn planet_child_rf_compile_rejects_invalid_planet_admission() {
    ...
    planet
        .properties
        .remove(&simthing_spec::PLANET_ID_PROPERTY_ID);
...
#[test]
fn planet_child_rf_compile_rejects_invalid_amounts() {
    let mut spec = build_planet_child_rf_admitted_spec();
    let star = spec
        .root
        .children
