//! Shared disburse-down scoped fixture for driver tests.
...
pub fn build_owner_silo_disburse_down_scoped_spec() -> SimThingScenarioSpec {
    ...
    apply_scenario_metadata_to_root(
        &mut root,
        "owner_silo_disburse_down_scoped",
        &provenance,
    ...
    apply_participant_owner_flow_demand_metadata(&mut terra_cohort, "owner_a", 20, Some(10));
    ...
    let mut spec = SimThingScenarioSpec {
        scenario_id: "owner_silo_disburse_down_scoped".into(),
        root,
