...
#[test]
fn frontier_v1_2_coupling_rejects_non_frontier_profile() {
    ...
    println!("frontier_v1_2_coupling: frontier_only=true fixture_id={FRONTIER_V1_GPU_FIXTURE_ID}");
    let _ = config;
}
...
fn frontier_v1_2_deferred_features_reject() {
    ...
    println!("frontier_v1_2_deferred: rejects=true fixture_id={FRONTIER_V1_GPU_FIXTURE_ID}");
}
