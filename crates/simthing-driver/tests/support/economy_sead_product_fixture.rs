//! Phase M Economy + SEAD product fixture orchestration (Option A).
//!
...
//! first-slice GPU-resident commitment path. CPU does not compute urgency or emit SEAD events.
...
pub const SEAD_COMMITMENT_EVENT_KIND: u32 = 0x5345_4144;
...
#[derive(Clone, Debug, PartialEq)]
pub struct SeadCommitmentOutcome {
...
pub fn run_sead_commitment_with_economy_weights(
    ctx: &GpuContext,
    preview: &CompiledFirstSliceScenarioPreview,
    economy: &EconomyBoundaryOutcome,
) -> SeadCommitmentOutcome {
