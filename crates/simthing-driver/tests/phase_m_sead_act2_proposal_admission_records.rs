...
use simthing_spec::{
    ...
    PhaseEFixtureProposalAdmissionAuthority, SEAD_ACT1_ADMITTED_TABLE_SIZE,
    SEAD_ACT2_DESCRIPTOR_ID, SEAD_EVENT1_CODE_COUNT,
};
...
fn sead_act2_dense_admission_corpus() {
    ...
    with_gpu(|ctx| {
        ...
        println!("sead_act2_dense: rows={} ordering={ORDERING_CLASS}", 64);
    });
}
