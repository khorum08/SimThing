...
fn frontier_v1_4_rejects_route_bypasses() {
    ...
    structural.field_policy.structural_via_threshold_emit = false;
    assert_eq!(
    ...
    movement.field_policy.movement_own_columns_only = false;
    assert_eq!(
    ...
    let _ = config;
    println!(
        "frontier_v1_4_bypass: rejects=true fixture_id={FRONTIER_V1_FIELD_POLICY_ROUTE_FIXTURE_ID}"
    );
}
...
fn frontier_v1_4_coupling_rejects_non_frontier_profile() {
    ...
    println!(
        "frontier_v1_4_coupling: frontier_only=true fixture_id={FRONTIER_V1_FIELD_POLICY_ROUTE_FIXTURE_ID}"
    );
    let _ = config;
}
...
fn frontier_v1_4_deferred_features_reject() {
    ...
    println!("frontier_v1_4_deferred: rejects=true fixture_id={FRONTIER_V1_FIELD_POLICY_ROUTE_FIXTURE_ID}");
}
