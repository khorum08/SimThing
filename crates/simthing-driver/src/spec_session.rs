...
pub struct SpecSessionState {
    ...
    /// or default-derived). Ordinary install without an admitted field plan
    /// leaves this `None`.
    pub comparative_projection:
        Option<crate::comparative_projection::ComparativeProjectionAdmission>,
    /// 5.8b seam A: already-admitted FieldAdjacency / field-plan registration
    /// binding carried from install. Not a second topology authority.
    pub admitted_field_plan: Option<crate::comparative_default_birth::AdmittedFieldPlanBinding>,
}
