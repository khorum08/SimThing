//! SCENARIO-0080-2-R4: SEAD field-consumption + exact sqrt (EC2).
//!
...
//! a sit-still vs step-opportunity SEAD decision. CPU oracle parity is the authority; no
...
pub const DRESS_REHEARSAL_R4_SEAD_FIELD_CONSUMPTION_ID: &str =
    "SCENARIO-0080-2-R4-SEAD-FIELD-CONSUMPTION";
pub const DRESS_REHEARSAL_R4_SEAD_FIELD_CONSUMPTION_STATUS_PASS: &str =
    "IMPLEMENTED / PASS - SEAD field-consumption + exact sqrt EC2";
...
pub fn run_dress_rehearsal_r4_sead_field_consumption(
...
pub fn replay_dress_rehearsal_r4_sead_field_consumption(
) -> (DressRehearsalR4Report, DressRehearsalR4Report) {
    let input = DressRehearsalR4Input::explicit_opt_in();
    (
        run_dress_rehearsal_r4_sead_field_consumption(&input),
        run_dress_rehearsal_r4_sead_field_consumption(&input),
    )
}

pub fn cpu_oracle_dress_rehearsal_r4_sead_field_consumption(
    input: &DressRehearsalR4Input,
...
fn base_report(
    ...
    DressRehearsalR4Report {
        id: DRESS_REHEARSAL_R4_SEAD_FIELD_CONSUMPTION_ID,
        status: DRESS_REHEARSAL_R4_SEAD_FIELD_CONSUMPTION_STATUS_PASS,
...
fn render_artifact_markdown(
    ...
    out.push_str("## R4 SEAD Field-Consumption Artifact\n\n");
