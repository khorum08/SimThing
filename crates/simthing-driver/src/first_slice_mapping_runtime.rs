...
pub fn compiled_stencil_to_gpu_config(
    ...
    StructuredFieldStencilConfig {
        ...
        source_col: compiled.source_col.raw_u32(),
        target_col: compiled.target_col.raw_u32(),
        ...
        operator: match compiled.operator {
            ...
            CompiledRegionFieldOperator::SaturatingFlux {
                ...
                u_sat,
                chi,
                choke_output_col: choke_output_col.map(ColumnIndex::raw_u32),
            },
        },
...
impl FirstSliceMappingSession {
    ...
    fn open_preview_with_budget(
        ...
        Ok(Self {
            ...
            n_dims,
            source_col: preview.stencil.source_col.raw_u32(),
            preview,
            scheduler,
            stencil,
            values,
