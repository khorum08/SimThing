...
use simthing_spec::{evaluate_planet_child_locations, save_scenario_spec_to_canonical_json};
...
#[test]
fn studio_reopen_candidate_adopts_candidate_with_surface_gridcell_tier() {
    let json = load_owner_silo_fixture_json();
    let (spec, _) =
