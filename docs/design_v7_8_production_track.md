...
| **A — Nested Resource Flow** | E-11B / E-11B-5 hierarchical allocation (depth > 2) | T2 | **A-0 ACCEPTED (A-0-ACCEPT-0, 2026-05-30) — Line A static nested Resource Flow CLOSED at first slice** | **none** — E-11B-5 dynamic enrollment needs a separate named scenario. E-11B-5 is not a v7.8 M/E/T blocker; parked behind future named product scenario (explicit nested admission only under already-enrolled parent preserving per-parent contiguous SlotRange; no Policy B/selector rerun/wildcard/gap-child promotion/slot compaction/indirection-list/default-on RF/hard-currency reroute/CPU fallback/simthing-sim awareness). |
...
| **V7.8-MET-CLOSEOUT-0** | Final v7.8 M/E/T closure sync: A-0/B-0/C-2 accepted; E-11B-5, atlas runtime, mixed-kind hard-currency ordering, and L3 parked behind future named scenarios | Docs-only sync | Done | — | [`phase_v7_8_met_closeout_results.md`](tests/phase_v7_8_met_closeout_results.md) |
