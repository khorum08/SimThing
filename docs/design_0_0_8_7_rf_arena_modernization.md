...
| 3.2 | `FIRST-CITIZEN-SPECIALISTS-0` | Phase 3: spatial / owner / session as first citizens on the protocol. | **PROBATION / proof-present / DA-review-pending** — authored `specialization=` on location+entity; OWNER_POLICY_WEIGHT_AUTHORITY out-of-band mint HEURISTIC guard + reach-log; citizen counts board/orientation (`spatial=1500 owner-seat=2 session-root=1`); zero new requirement kinds; full battery UNMODIFIED | Std — Grok | **PROBATION / proof-present / DA-review-pending** |
...
| Item | State |
|---|---|
| Active open rung | `ROW-SLOT-OBJECT-SEMANTICS-0` |
