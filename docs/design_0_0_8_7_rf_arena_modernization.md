...
| 2.3 | `ORDER-WEIGHT-CLASS-0` | Phase 2: authored finite order-weight class + `OverlaySource::Player` directive path (orders = price injections). | **PROBATION / proof-present / DA-review-pending** — typed finite order-weight class; Player directive path; destination-order exemplar dominates on live GPU; non-finite/class-less span; dual-run bit-exact. | Std — Grok | **PROBATION / proof-present / DA-review-pending** — `HD-RECEIPT: 1b74667c3200`; `ORIENT-RECEIPT: 16b366e49528`. |
...
| Item | State |
|---|---|
| Active open rung | `SPECIALIZATION-PROTOCOL-0` |
