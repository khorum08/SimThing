...
| 5.8 | `GUYANG-COMPARATIVE-PROJECTIONS-0` | Phase 5: dominance/margin/contest/border-band/chokepoint projections; default-derived at ≥2 emitter classes; deterministic tie-break; consumes generic field-sweep outputs. | **PROBATION / proof-present / DA-review-pending** — sealed comparative projection authority over co-located field-sweep outputs; fixed derived column count independent of emitter N; CPU oracle + field-EML + GPU (RTX 4080/Vulkan) bit parity; authored tie-break + reversal falsifier; chokepoint conjunction controls; TP asset zero-wiring + front/chokepoint threshold witness. | Std — Grok | **PROBATION** |
