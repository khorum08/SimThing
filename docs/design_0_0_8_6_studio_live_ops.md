...
| Active open rung | `STUDIO-DISRUPTION-SELECT-SCREEN-0` — **12.3 PROBATION / DRAFT** (PR [#1420](https://github.com/khorum08/SimThing/pull/1420); DA enrollment `5027107657`; resume `5027952564`; HD-RECEIPT `3a9d055fb8aa`). 12.10 is **DA-GRADUATED / merged [#1418](https://github.com/khorum08/SimThing/pull/1418) @ `ced8ce2d`**. Production `system_target` enrollment landed; Owner alone closes OVL after orch accept + re-freeze. Keep draft/open/unmerged; no self-graduation, readiness mutation, or merge. 12.5 remains queued. |
