...
| Active open rung | `STUDIO-DISRUPTION-SELECT-SCREEN-0` — **12.3 PROBATION / DRAFT** (PR [#1420](https://github.com/khorum08/SimThing/pull/1420); dispatch `5022654370`; HD-RECEIPT `3a9d055fb8aa`). 12.10 is **DA-GRADUATED / merged [#1418](https://github.com/khorum08/SimThing/pull/1418) @ `ced8ce2d`**. Presentation-only selected-star disruption screen; Owner alone closes OVL. Keep draft/open/unmerged; no self-graduation, readiness mutation, or merge. 12.5 remains queued. |
