...
| 9.7 | `STUDIO-LIVE-OPS-CLASS-0` | **Gate-wiring.** Precedented class for live-ops UI + clock shape. | **PROBATION** — [#1293](https://github.com/khorum08/SimThing/pull/1293) @ `7897f650`; class `studio-live-ops-ui-clock` + predicate (priority 40); 12 fixtures clearable + envelope rejects; selftest 90 PASS; evidence [`studio_live_ops_class_0_results.md`](tests/studio_live_ops_class_0_results.md). Not graduated. | Tier-2 |
...
| Active open rung | `STUDIO-LIVE-OPS-CLASS-0` **PROBATION** (class registration; not graduated) → next `STUDIO-LIVE-OPS-HARDENING-0` |
...
**Park instruction for agents:** 9.0–9.6 landed; 9.7 class hardening in PROBATION. Next after 9.7 graduates: `STUDIO-LIVE-OPS-HARDENING-0` (incl. JSON/Clause bridge-reset residual). Do not treat orientation pointer as closeout of 0.0.8.5.
