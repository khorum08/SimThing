...
| RF-3 | `RF-LEGACY-RETIRE-REANCHOR-0` | Repoint existing RF tests + `runtime_0080_*` rehearsal + recursive-source oracle framing to the new default + RF-1 oracle; retire dead legacy; re-anchor the ADR/anchors so recursive-executed-by-default is the doctrine future agents ingest. **Needs RF-2.** | **PROBATION (proof-present, orchestration-review-pending)** — tested code `63d89ff9d4994f390f6bfede08f0d5b0823c7d66`; evidence `docs/tests/rf_legacy_retire_reanchor_0_results.md`. | DA-reserve |
...
| Active open rung | `RF-LEGACY-RETIRE-REANCHOR-0` — **RF-3 PROBATION (proof-present, orchestration-review-pending)**; tested code `63d89ff9d4994f390f6bfede08f0d5b0823c7d66`, evidence `docs/tests/rf_legacy_retire_reanchor_0_results.md`, HD-RECEIPT `11035f9c5602`. RF-2A + RF-2 DA-graduated and merged in [#1411](https://github.com/khorum08/SimThing/pull/1411) @ `c206b0ef`. Queue after graduation: RF-4 (=12.9). |
