...
| Active open rung | **PROBATION (proof-present, DA-review-pending)** — `WORKSHOP-HOMING-DETECTION-0` 12.7 RE-DISPATCHED 2026-07-17 (HD-RECEIPT 7075231f4d13, base a83f98dd; RELIABLE→HEURISTIC DA correction); fully-automated (coder=Codex-CLI gpt-5.5-high, orchestrator-led). Queue after: 12.8 TP-CLAUSE-ECONOMY-AUTHOR-0 → 12.9 → 12.10. |
