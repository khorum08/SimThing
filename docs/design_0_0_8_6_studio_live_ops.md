...
| Active open rung | `STUDIO-LIVE-OPS-CLASS-0` (after 9.0–9.6 graduated) |
...
**Park instruction for agents:** 9.0–9.6 landed (clock + UI + live bridge + observation + scenario library modal + blank create). Next: `STUDIO-LIVE-OPS-CLASS-0`; do not treat orientation pointer as closeout of 0.0.8.5.
