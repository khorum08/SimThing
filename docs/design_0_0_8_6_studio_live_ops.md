...
| Active open rung | `SCANNER-SELFTEST-DELTA-GATE-0` — 12.11 DISPATCHED 2026-07-17 (HD-RECEIPT 38e50dc06675, base 5d0ad485); AUTONOMOUS run (coder=Codex-CLI visible, orchestrator-led). Owner-mandate mechanization (scanner selftests must not run every PR). TP chain deferred behind it: 12.8 TP-CLAUSE-ECONOMY-AUTHOR-0 → 12.9 → 12.10. |
