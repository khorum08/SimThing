...
| RF-4 | (12.9 resumes) `STUDIO-FIELD-SESSION-ELEVATE-0` | Studio field-bearing consumes the now-executing RF; telemetry binds to the real ancestor aggregate; Owner OVL closes. Need/weight-profile install seam resolves here or splits to RF-5. **Needs RF-2.** | **OWNER OVL PASS / orchestration-review-complete / DA-relay-ready / RF-5 SPLIT APPROVED** — ruling `5012654906` accepts implementation `4334acda`, Vulkan/non-DX12 exact-RTX telemetry, canonical loaded/live aggregate `0/15`, and the frozen executable hash `4f2fa46b3152974e7957117c99ef50190614a319ed3ba8fecda4a89b688ff4c9`. Recursive RF bite remains `15/10`, marginal `5`, and governed-Balance disconnect → `ResidualNotIntegrated`. DX12 crash paths are superseded evidence; need transport remains bounded RF-5 and screenshot C remains out of scope. HD-RECEIPT `a8e70c897f36`. | DA-reserve |
...
| Active open rung | `STUDIO-FIELD-SESSION-ELEVATE-0` — **RF-4 / 12.9 OWNER OVL PASS / orchestration-review-complete / DA-relay-ready / RF-5 SPLIT APPROVED** (HD-RECEIPT `a8e70c897f36`). RF-3 DA-graduated and merged in [#1412](https://github.com/khorum08/SimThing/pull/1412) @ `d42b9109`; RF-4 consumes ordinary recursive-default RF and proves the real Owner aggregate. Final crash-fenced implementation `4334acda` is Owner/Ovl accepted under ruling `5012654906`; exact RTX/NVIDIA/discrete selection remains fail-closed on supported non-DX12 backends with truthful telemetry. Need/`weight_profile` transport is deferred to bounded RF-5. PR #1413 remains draft/open pending orchestration's DA relay. |
