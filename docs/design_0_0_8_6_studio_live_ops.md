...
| 11.6 | `STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0` | **Needs 11.2.** Selecting a faction-owned star **brightens all stars that faction owns** to reflect the owned/selected set; deselect restores. Presentation-only render state; no Spec mutation, no selection-model authority. | **PROBATION** [#1312](https://github.com/khorum08/SimThing/pull/1312) @ `5b249557` — owned-set star visual highlight from owner_flow_owner_ref; unowned no group; deselect clears; actual selection preserved; evidence [studio_owned_star_select_brighten_0_results.md](tests/studio_owned_star_select_brighten_0_results.md). Not graduated. | Tier-2 · Std |
...
| Active open rung | `STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0` (Phase 11; 11.1–11.5 graduated) |
...
**Park instruction for agents:** Phase 9 complete; Phase 10 parked. Phase 11 active at `STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0` (11.6, Std). Do not reopen 0.0.8.5.
