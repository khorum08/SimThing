...
| 9.7 | `STUDIO-LIVE-OPS-CLASS-0` | **Gate-wiring.** Precedented class for live-ops UI + clock shape. | **PROBATION** — class `studio-live-ops-ui-clock` + predicate (priority 40); 12 fixtures clearable + envelope rejects; selftest 90 PASS; evidence [`studio_live_ops_class_0_results.md`](tests/studio_live_ops_class_0_results.md). Not graduated. | Tier-2 |
