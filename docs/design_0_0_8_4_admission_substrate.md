...
| F | `AS-CLOSEOUT-0` | — | Scope Ledger across rungs: invariants promoted, **guards/prose retired (the success metric)**, parity intact. DA review. | — | Haiku/Sonnet (docs) | **PROBATION** |
