...
> newtypes across production/report RF surfaces; DA re-review pending. Rung **5 `AS-INDEX-NEWTYPES-0`** remains
> **horizon / unbuilt** — it is the next coding rung (Cursor/Grok), not a DA-graduation item. Rungs **1–4**
