...
| **GPU-LINK-ACCUMULATOR-SMOKE-0** - fixed-point i32 neighbor accumulation over canonical structural links; CPU oracle; vertical-seed-pulled GPU proof | branch evidence | branch evidence | PROBATION - `docs/tests/gpu_link_accumulator_smoke_0_results.md`; synthesis `docs/0.8.3 Simthing Studio Production.md`; GPU evidence REAL_ADAPTER_OBSERVED |
