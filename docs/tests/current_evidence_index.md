...
| **BEVY-MAPGEN-EDITOR-PR2R** — star visibility at overview scale + shape-param scoping (Disc no longer blocked by dormant spiral arm_* params) | — | pending merge | PROBATION — `docs/tests/bevy_mapgen_editor_pr2r_results.md` |
