...
| **MAPGENCLI-EDITOR-PREP-0** — fail-closed `--shape-param` validation + deterministic `--report-json` (`mapgenerator.report.v1`) for Bevy/editor consumption | pending | pending | PROBATION — sample report at `docs/tests/mapgenerator_cli_spiral2_dense_3000_editor_prep.report.json` |
