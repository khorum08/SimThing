...
| **BEVY-MAPGEN-EDITOR-PR1** — Windows SimThing Studio shell: Bevy borderless window, egui panels, 3D galaxy viewer via typed MapGenerator path | pending | pending | PROBATION — `docs/tests/bevy_mapgen_editor_pr1_results.md` |
