...
| **BEVY-MAPGEN-EDITOR-PR1R** — Studio shell contract repair: floating panel, warning-clickable controls, camera/orbit, hyperlane depth buckets | pending | pending | PROBATION — `docs/tests/bevy_mapgen_editor_pr1r_results.md` |
