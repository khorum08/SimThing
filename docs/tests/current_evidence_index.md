...
| **BEVY-MAPGEN-EDITOR-PR2R3** — distance-attenuated core/aura star sprites + camera-depth hyperlane shader inputs | pending | pending | PROBATION — `docs/tests/bevy_mapgen_editor_pr2r3_results.md` |
