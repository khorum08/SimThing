...
| **MAPGENCLI-TOPOLOGY-STEAD-1** — sibling producer couplings (special routes, partition bridges + BFS/DFS ordering, cluster bridges) migrated to authored coords; dispersion guard proves spiral placement is not a brick | (this PR) | (pending) | PROBATION (DA sign-off pending — `mapgenerator_cli_topology_stead_1_results.md`) |
