# SEAD tensor/stencil WGSL refinement probe — test results

**Date/time:** 2026-05-19  
**Base HEAD (before sandbox branch):** `aa001b1` — SEAD tensor/stencil WGSL revert doc update  
**Sandbox merge SHA:** _(filled after merge PR)_  
