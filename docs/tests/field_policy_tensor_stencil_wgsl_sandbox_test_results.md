# FIELD_POLICY tensor/stencil WGSL prototype probe — test results

**Date/time:** 2026-05-19  
**Base HEAD (before sandbox branch):** `6338789` — FIELD_POLICY operator toolkit revert HEAD doc update  
...
| Command | Result |
|---------|--------|
| `cargo test -p simthing-driver --test field_policy_tensor_stencil_wgsl_sandbox -- --nocapture --test-threads=1` | **PASS** — 10/10 |

**Full log:** [`archive/field_policy/field_policy_tensor_stencil_wgsl_sandbox_full.log`](archive/field_policy/field_policy_tensor_stencil_wgsl_sandbox_full.log)
...
- Rust: [`docs/workshop/archive/field_policy/field_policy_tensor_stencil_wgsl_sandbox_code_preserve.rs`](../workshop/archive/field_policy/field_policy_tensor_stencil_wgsl_sandbox_code_preserve.rs)
- WGSL: [`docs/workshop/archive/field_policy/field_policy_tensor_stencil_prototype.wgsl`](../workshop/archive/field_policy/field_policy_tensor_stencil_prototype.wgsl)
- Variant copies: `field_policy_tensor_stencil_*_prototype.wgsl` under `docs/workshop/archive/field_policy/`
- Notes: [`docs/workshop/archive/field_policy/field_policy_tensor_stencil_prototype_notes.md`](../workshop/archive/field_policy/field_policy_tensor_stencil_prototype_notes.md)
