...
- **R1-TEST-PURGE (2026-06-11):** Legacy R1* proof-ledger/report/checksum tests were deleted or quarantined from the default workspace gate. Default workspace now retains only fast production-relevant R1* sentinels. Historical proof batteries must not be reintroduced as default tests. Prior R1C-B/C cleanup: [`tests/r1c_default_gate_cleanup_results.md`](tests/r1c_default_gate_cleanup_results.md). Full purge: [`tests/r1_default_workspace_purge_results.md`](tests/r1_default_workspace_purge_results.md)
