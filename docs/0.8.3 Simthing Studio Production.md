...
**Date / PR:** 2026-06-20 — PLANET-CHILD-RF-GPU-PARTICIPANT-0 (pre-merge; builds on PR #792)
...
1. Full owner-silo state mutation remains deferred.
2. Local RF resolution / surplus-deficit reduce-up remains next after participant GPU proof.
