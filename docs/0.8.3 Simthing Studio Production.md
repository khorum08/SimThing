...
**Date / PR:** 2026-06-20 — PLANET-CHILD-RF-REDUCE-UP-0 (pre-merge; builds on PR #795)
...
1. Owner-silo state mutation / writeback remains next after scoped reduce-up proof.
2. Disburse-down remains after mutation/writeback.
