...
**Date / PR:** 2026-06-20 — PR TBD — RUNTIME-RF-TICK-INTEGRATION-0 (merge TBD; builds on PR #799)
...
2. Local participant consumption/effect semantics remain deferred until tick shell proof.
