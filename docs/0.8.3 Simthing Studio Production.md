...
**Date / PR:** 2026-06-20 — PR TBD — RUNTIME-LOCAL-ALLOCATION-APPLICATION-0 (merge TBD; builds on PR #798)
...
2. Local participant state consumption/effect semantics remain deferred until tick boundary proof.
