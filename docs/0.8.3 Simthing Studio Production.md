...
**Date / PR:** 2026-06-19 — GENERAL-SCENARIO-INGESTION-ADMISSION-0
...
1. **SESSION-RESOURCE-FLOW-SILOS-0** — stockpile reduce-up/disburse-down execution under Owners.
2. Studio ingestion report display / scenario admission UI (if not covered in a follow-on PR).
3. GPU-resident execution/visualization only after admitted scenario authority remains enforced.
4. Structural placement edit commands and full editor mutation command surface beyond safe metadata roundtrip.
