...
| CT-2c category economy | **DESIGN MEMO / READY FOR REVIEW** (2026-06-11, CT-2c-DESIGN-1; categories = hydration/admission metadata that compiles away; economic key family only, longest-match; no spec widening, no new AccumulatorRole; implementation gated on memo acceptance, stays [FRONTIER]) | [`docs/clausething/ct_2c_economic_category_memo.md`](clausething/ct_2c_economic_category_memo.md) |
