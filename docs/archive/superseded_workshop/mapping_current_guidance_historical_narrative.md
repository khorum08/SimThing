...
The full first-slice vertical FIELD_POLICY slice is **accepted as complete for the single-grid, opt-in
...
proving the FIELD_POLICY commitment path: GPU-resident field propagation -> parent reduction ->
...
GPU-resident FIELD_POLICY path: field propagation -> parent reduction -> field_urgency EvalEML ->
Threshold + EmitEvent.
