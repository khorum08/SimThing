...
**Sequencing:** A1 → A2 → (A3 ∥ A4) → C. Lane B rungs slot anywhere after A1, each on Owner
authorization; C does not wait for unauthorized K rungs.
