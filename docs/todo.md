...
**Next (non-Opus):** **C-8c** transfer · **C-8d** emission · **S-2** intensity sunset · **S-3** overlay sunset · per-family oracle expansion. C-8b intensity EvalEML + remedial op-cache hardening landed locally.
