...
**Next (non-Opus):** **S-2** legacy intensity deletion (see `docs/workshop/s2_legacy_intensity_sunset_inventory.md`) · **S-3** overlay sunset · per-family oracle expansion. C-8 block complete; completion gate landed locally.
