...
**Next (non-Opus):** **C-8d** emission · **S-2** intensity sunset · **S-3** overlay sunset · per-family oracle expansion. C-8c transfer substrate + remedial contention hardening landed locally.
