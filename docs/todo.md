...
1. **RF-T3 product-like opt-in soak / telemetry surfacing** — not global default-on
...
**Next (immediate):** RF-T3 product-like opt-in soak / telemetry surfacing; or E-11B, D-2a per product priority.
