...
**Phase M EML Gadget Library:** **EML-GADGET-1 Done; EML-GADGET-1 R1 Done (2026-05-29).** Tier-1 gadgets with CPU-oracle parity; R1 clarifies `EmlGadgetCompositionPlan` (per-gadget executable; multi-gadget chained stacks `PerGadgetOnly`). **EML-GADGET-2** queued. Tests: [`tests/phase_m_eml_gadget_tier1_test_results.md`](tests/phase_m_eml_gadget_tier1_test_results.md), [`tests/phase_m_eml_gadget_tier1_r1_hygiene_test_results.md`](tests/phase_m_eml_gadget_tier1_r1_hygiene_test_results.md).
