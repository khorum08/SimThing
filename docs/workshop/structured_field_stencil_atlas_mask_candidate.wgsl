// Sandbox-only: algebraic tile-local atlas masking prototype (M-4A).
// Not wired into production pass graph. Semantic-free.
// Preserved from crates/simthing-gpu/src/shaders/structured_field_stencil_atlas_mask_sandbox.wgsl
