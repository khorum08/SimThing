# SEAD tensor/stencil WGSL refinement probe — workshop notes
...
- Single parametric WGSL kernel (`sead_tensor_stencil_refinement_prototype.wgsl`) with `variant` and `directed_mode` uniforms.
