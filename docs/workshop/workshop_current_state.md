...
**Master HEAD:** E-11 controlled opt-in CI soak (pending merge)  
...
**Next gates:** Opus production transfer/emission registration ownership · limited opt-in scenario flagging (optional) · D-1 discrete-transaction contention memo. **E-11B** nested hierarchy GPU remains deferred. **E-2B** blocked unless enrollment compilation explicitly lands.
