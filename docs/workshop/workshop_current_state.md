...
**Next action:** **M-JIT-COHORT-0 R1 collision-test helper fenced from public spec API** — cohort preview public surface is `preview_kernel_graph_cohorts` only; production registry/scheduler/runtime cache and JIT dispatch remain separately gated.
