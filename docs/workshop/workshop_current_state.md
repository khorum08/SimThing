...
**Next action:** **M-JIT-COHORT-0 deterministic kernel graph cohort grouping preview landed** — admitted requests group by stable identity; production registry/scheduler/runtime cache and JIT dispatch remain separately gated.
