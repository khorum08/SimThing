...
**Next action:** **M-JIT-REG-1 production-candidate registry admission preview landed** — exact-only TestOnly entries may promote to non-dispatching ProductionCandidatePreview; production registry/scheduler/runtime cache and JIT dispatch remain separately gated.
