...
**Next action:** **M-JIT-KEY-0 deterministic kernel graph identity/cache-key preview landed** — admitted graphs produce stable canonical identity; production registry/scheduler/runtime cache and observer/JIT scheduling remain separately gated.
