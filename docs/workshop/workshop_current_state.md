...
**Next action:** **M-JIT-REG-0 test-only kernel registry manifest preview landed** — cohort previews convert to deterministic TestOnly registry entries; production registry/scheduler/runtime cache and JIT dispatch remain separately gated.
