//! FIELD_POLICY tensor/stencil WGSL refinement probe — stability, directed setup, column-aware parent EML.
...
fn guard_no_production_pipeline_integration() {
    ...
    assert!(!passes.contains("field_policy_tensor_stencil_refinement"));
}
...
fn test9_generality_review() {
    let wgsl = include_str!("../../simthing-gpu/src/shaders/field_policy_tensor_stencil_refinement_prototype.wgsl");
