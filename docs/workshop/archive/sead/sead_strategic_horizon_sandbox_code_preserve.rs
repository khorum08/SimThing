//! SEAD strategic horizon / velocity column / PF-skip feasibility probe (prototype only).
//!
//! Extends the first SEAD probe on unresolved questions: long-range gradient horizon,
