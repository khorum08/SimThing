...
| **L1-ACCEPT-0 — simthing-spec buildout closure / L2 gate** | **T2** | **L1 ACCEPTED → L2 OPEN** | Design authority accepted L1 (L1-0 + L1-1) as sufficient designer/spec admission substrate; **L2 / CLAUSE-SPEC-0 is now the open next gate** (designer-authored FrontierV2 scenario admission); ClauseThing/ClauseScript parked; FrontierV2-5 rejected; one non-blocking preview.rs diagnostic-code nit noted for L2. Report: [`phase_m_l1_acceptance_review_results.md`](../tests/phase_m_l1_acceptance_review_results.md) |
| **CLAUSE-SPEC-0 — designer-authored FrontierV2 scenario admission** | **T2** | **landed; pending design-authority review** | RON-first, default-off FrontierV2 scenario admission through `simthing-spec`; lowers to accepted FrontierV2 fixture artifact targets and enforces guardrails at admission. ClauseThing/ClauseScript and production runtime remain parked. Report: [`phase_m_clause_spec0_frontier_v2_admission_results.md`](../tests/phase_m_clause_spec0_frontier_v2_admission_results.md) |
