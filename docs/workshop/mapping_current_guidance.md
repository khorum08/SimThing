...
| **Shader/software deterministic sqrt / SEAD observer** | **T2** | **SEAD-OBS-2 landed** | SEAD-OBS-1: [`phase_m_sead_obs1_overlay_score_admission_results.md`](../tests/phase_m_sead_obs1_overlay_score_admission_results.md). SEAD-OBS-2: [`phase_m_sead_obs2_multilayer_overlay_score_results.md`](../tests/phase_m_sead_obs2_multilayer_overlay_score_results.md). **SEAD-OBS-2 landed:** default-off/test-only multi-layer observer overlay score pass consumes four Q16.16 + F magnitude layers per row. Per-layer magnitudes remain exact; score remains ApproximateDiagnostic under f32 weighting. No scheduler/cache/default wiring/production bridge. F artifact hash `e2e9e27601ee2e13`. |
