...
> allocator substrate only; **MOBILITY-REENROLL-0 is PASS for bilateral arena re-enrollment substrate only.**
...
> (ALLOC + REENROLL substrate green; IDROUTE/ECON/OWNER parked). (Charter:
...
| **MOBILITY-SCENARIO-0 — v7.9 mobility/transfer scenario admission packet** | **T2** | **ACCEPTED; MOBILITY-AUDIT-0 PASS; MOBILITY-ALLOC-0 PASS; MOBILITY-REENROLL-0 PASS** | Bounded first-slice scenario (depth 4, k≤4, 48 cells, 34k soak, narrowed adversarial routing) accepted as the named v7.9 scenario; guardrail rejections wired/tested. `owner_band_budget_audit` requires 13 of current 16 OrderBands. ALLOC + REENROLL green only for substrate layers; IDROUTE/ECON/OWNER stay parked; no production runtime gate. Reports: [`phase_mobility_scenario0_acceptance_review_results.md`](../tests/phase_mobility_scenario0_acceptance_review_results.md), [`phase_mobility_owner_band_budget_audit_results.md`](../tests/phase_mobility_owner_band_budget_audit_results.md), [`phase_mobility_alloc0_results.md`](../tests/phase_mobility_alloc0_results.md), [`phase_mobility_reenroll0_results.md`](../tests/phase_mobility_reenroll0_results.md). |
