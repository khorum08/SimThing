...
> allocator substrate only; **MOBILITY-REENROLL-0 is PASS; MOBILITY-IDROUTE-0 is PASS** for local D=2 identity-routing overlay substrate.
...
> (ALLOC + REENROLL green; IDROUTE substrate authorized; ECON/OWNER parked). (Charter:
...
| **MOBILITY-SCENARIO-0 — v7.9 mobility/transfer scenario admission packet** | **T2** | **ACCEPTED; ... ; MOBILITY-IDROUTE-0 PASS** | ... IDROUTE local D=2 substrate green. ECON/OWNER parked. Reports include `phase_mobility_idroute0_results.md`. |
