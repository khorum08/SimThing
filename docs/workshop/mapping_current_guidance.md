...
| **SCENARIO-0080-0 — Local Patrol Economy (0.0.8.0)** | **T2** | **ACCEPTED; PRODUCTION-PATH/DEFAULT-SCHEDULE/GAMEPLAY/CONTROL all IMPLEMENTED / PASS** | First consumer-pulled scenario. `admit_control_0080_0` bounded command admission; direct movement/UI/realtime remain closed. Reports: gameplay [`../tests/phase_gameplay_0080_0_impl_results.md`](../tests/phase_gameplay_0080_0_impl_results.md); control [`../tests/phase_control_0080_0_impl_results.md`](../tests/phase_control_0080_0_impl_results.md); production path [`../tests/phase_production_path_0080_0_impl_results.md`](../tests/phase_production_path_0080_0_impl_results.md). |
