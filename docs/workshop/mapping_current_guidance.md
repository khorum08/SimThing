...
| **Shader/software deterministic sqrt** | **T2** | **SEAD-OBS-0 landed** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-MAG2-PERF-0: [`phase_m_jit_sqrt_mag2_perf0_fixed_hotpath_results.md`](../tests/phase_m_jit_sqrt_mag2_perf0_fixed_hotpath_results.md). SEAD-OBS-0: [`phase_m_sead_obs0_mobile_overlay_score_results.md`](../tests/phase_m_sead_obs0_mobile_overlay_score_results.md). **SEAD-OBS-0 landed:** a default-off/test-only GPU-resident mobile observer overlay score pass consumes exact Q16.16 mag2 + F sqrt. Magnitude remains exact under the fixed-point contract; score authority follows its arithmetic (f32 diagnostic). No scheduler/cache/default wiring/production bridge. F artifact hash `e2e9e27601ee2e13`. |
