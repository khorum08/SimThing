...
| **Frontier V1 — named closing scenario (M + E)** | **T2** | **FrontierV1-5 ACCEPTED (Opus design authority, 2026-05-30; code-verified live GPU route). Substrate + self-AI resource-dispatch loop GpuVerified (bounded single-tick); structural/movement ReplayAccepted; next gate = `FrontierV2-0` (multi-tick closed-loop consumer; proves structural/movement within it)** | Single-theater strategic vertical on accepted substrates: one ≤32×32 grid (first-slice mapping, no atlas/mask), two flat-star depth-2 faction economies (FlatStarResourceFlow, no nested E-11B), mobile cohorts self-directing on the field via exact F-magnitude + SEAD self-AI, commitments via Threshold/EmitEvent. One opt-in `FrontierV1` profile, **default Disabled**. **Design-authority review (Opus, 2026-05-30 — `sead_self_ai_track.md` §10):** implementer `FrontierV1-ACCEPT-0` / `FrontierV1-POSTACCEPT-0` are *self-acceptance* and do not constitute M/E closure. **Substrate (mapping + flat-star RF) GPU-verified and ACCEPTED → Phase E closes at flat-star.** **FrontierV1-5:** required live GPU-resident integrated self-AI route run per Opus §10, now shaped toward the FrontierV2 Forward Horizon. Executes score→threshold→proposal→dispatch inside default-off FrontierV1, consuming accepted SEAD V1 without reopening ACT/EVENT/OBS/PIPE ladder. Resource route must dispatch through Resource Flow allocator and produce a fixture-only feedback candidate for FrontierV2. **`FrontierV2` is the forward horizon — multi-tick closed-loop consumer; not implemented in V1-5.** Reports: [`phase_m_frontier_v1_0_scenario_skeleton_results.md`](../tests/phase_m_frontier_v1_0_scenario_skeleton_results.md), [`phase_m_frontier_v1_1_opt_in_fixture_results.md`](../tests/phase_m_frontier_v1_1_opt_in_fixture_results.md), [`phase_m_frontier_v1_2_gpu_replay_acceptance_results.md`](../tests/phase_m_frontier_v1_2_gpu_replay_acceptance_results.md), [`phase_m_frontier_v1_3_gpu_resource_flow_results.md`](../tests/phase_m_frontier_v1_3_gpu_resource_flow_results.md), [`phase_m_frontier_v1_4_sead_route_replay_results.md`](../tests/phase_m_frontier_v1_4_sead_route_replay_results.md), [`phase_m_frontier_v1_5_live_self_ai_route_results.md`](../tests/phase_m_frontier_v1_5_live_self_ai_route_results.md), [`phase_m_frontier_v1_acceptance_review_results.md`](../tests/phase_m_frontier_v1_acceptance_review_results.md), [`phase_m_frontier_v1_post_acceptance_roadmap_results.md`](../tests/phase_m_frontier_v1_post_acceptance_roadmap_results.md). Charter: [`sead_self_ai_track.md`](sead_self_ai_track.md). |
| **Frontier V2 — multi-tick closed-loop consumer** | **T2** | **FrontierV2-0/1/2/3 landed (fixture/test support only; no phase closure; ClauseThing NotImplemented)** | **FrontierV2-0:** first default-off multi-tick closed-loop consumer fixture. Report: [`phase_m_frontier_v2_0_closed_loop_consumer_results.md`](../tests/phase_m_frontier_v2_0_closed_loop_consumer_results.md). **FrontierV2-1:** closed-loop movement/structural FixtureCandidate evolution. Report: [`phase_m_frontier_v2_1_candidate_evolution_results.md`](../tests/phase_m_frontier_v2_1_candidate_evolution_results.md). **FrontierV2-2:** fixture-only own-column movement feedback application. Report: [`phase_m_frontier_v2_2_movement_feedback_application_results.md`](../tests/phase_m_frontier_v2_2_movement_feedback_application_results.md). **FrontierV2-3:** fixture-only structural BoundaryRequest feedback application across ticks. Builds on FrontierV2-2 movement feedback; structural candidate enqueues BoundaryRequest shadow record and feeds next-tick structural context. ClauseThing remains unimplemented; no phase closure declared. Report: [`phase_m_frontier_v2_3_structural_feedback_application_results.md`](../tests/phase_m_frontier_v2_3_structural_feedback_application_results.md). |
