...
- **`RUNTIME-0080-0 R2` ACCEPT / CLOSED (`R2-REVIEW-0`, design authority):** stable 100-tick GPU-forward rehearsal over R1a–R1c-f; checksum-equivalent to pinned R6C `1bba891c779190a4` (assigned on per-tick + endpoint parity, not a fresh R2-state hash); remaining CPU-decided classes are findings not blockers; M-4A parked. **RUNTIME-0080-0 closed at this horizon — no new rung until a consumer is chosen.** Report: [`../tests/runtime_0080_0_r2_stable_100_tick_rehearsal_results.md`](../tests/runtime_0080_0_r2_stable_100_tick_rehearsal_results.md); profiling: [`../tests/runtime_0080_0_r2_profiling_capture.md`](../tests/runtime_0080_0_r2_profiling_capture.md).
