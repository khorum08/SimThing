...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-EXACT-0 landed (test-only battery)** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). Test battery: [`phase_m_jit_sqrt_exact_candidate_battery_results.md`](../tests/phase_m_jit_sqrt_exact_candidate_battery_results.md). Candidates A/B only; C/f64 rejected. Native sqrt remains `ApproximateJitOnly`; exhaustive proof gate ignored by default. M-JIT closure unchanged. |
