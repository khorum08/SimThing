...
- **`RUNTIME-0080-0 R1a` IMPLEMENTED / PASS (Outcome A, 2026-06-05):** Tier-A GPU-STATE-AUTH-0 resident next-tick authority on production `WorldGpuState`/`Pipelines`; measured per-column parity vs R6C oracle; negative control earned; `gpu_state_feeds_next_tick=true`; report checksum `f0244d3d9106900d`. Report: [`../tests/runtime_0080_0_r1a_next_tick_authority_results.md`](../tests/runtime_0080_0_r1a_next_tick_authority_results.md). Remaining horizons: R1b event journal, R1c REENROLL/scatter/compact, M-4A, recursion, multi-faction ECON. Opcode/WGSL-gate clarification (Opus, 2026-06-05): generic, semantic-free `Floor` EvalEML and Candidate-F max-magnitude WGSL helper were admitted under handoff §4a; semantic ops stay banned and anti-faking is unchanged. Handoff: [`../handoffs/runtime_0080_0_r1a_remedial_opening.md`](../handoffs/runtime_0080_0_r1a_remedial_opening.md); spec §14/§14.1: [`../production_paths/runtime_0080_0_r1_next_tick_authority_spec.md`](../production_paths/runtime_0080_0_r1_next_tick_authority_spec.md). **R1b/R1c remain parked:** R1b (`RESIDENT-EVENTLOG-0`) -> R1c (`RESIDENT-REENROLL-0`).
