...
- **Next consumer (`RUNTIME-0080-0-CLOSED-NEXT-CONSUMER-0`): C — M-4A / multi-atlas sparse residency, OPEN as capability track.** `RUNTIME-0080-M4A-OPEN-0`: prove the closed 100-tick GPU-forward runtime runs across N ≥ 2 resident theaters under one sparse-residency dispatch; first slice `RUNTIME-0080-M4A-0` reuses the R2 loop per theater. Capability/infrastructure only — no gameplay overclaim. Opening spec: [`../production_paths/runtime_0080_m4a_opening_spec.md`](../production_paths/runtime_0080_m4a_opening_spec.md). Gameplay emergence (`SCENARIO-0080-3`), multi-faction economy, recursion remain parked.
