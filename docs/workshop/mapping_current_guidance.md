...
- **`RUNTIME-0080-0 R2` PASS:** stable 100-tick GPU-forward rehearsal over R1a–R1c-f; R6C checksum `1bba891c779190a4`; remaining CPU-decided classes are findings not blockers; M-4A remains parked. Report: [`../tests/runtime_0080_0_r2_stable_100_tick_rehearsal_results.md`](../tests/runtime_0080_0_r2_stable_100_tick_rehearsal_results.md).
