...
> territory (ALLOC substrate green; downstream ladders parked):** [`mobility_and_transfer_allocation.md`](mobility_and_transfer_allocation.md)
...
> (ALLOC substrate green; downstream ladders parked). (Charter:
