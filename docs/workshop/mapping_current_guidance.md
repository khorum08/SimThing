...
| **Shader/software deterministic sqrt / SEAD observer** | **T2** | **SEAD-ACT-2 landed** | SEAD-OBS-1: [`phase_m_sead_obs1_overlay_score_admission_results.md`](../tests/phase_m_sead_obs1_overlay_score_admission_results.md). SEAD-OBS-2: [`phase_m_sead_obs2_multilayer_overlay_score_results.md`](../tests/phase_m_sead_obs2_multilayer_overlay_score_results.md). SEAD-OBS-3: [`phase_m_sead_obs3_fixed_point_score_results.md`](../tests/phase_m_sead_obs3_fixed_point_score_results.md). SEAD-OBS-4: [`phase_m_sead_obs4_threshold_event_results.md`](../tests/phase_m_sead_obs4_threshold_event_results.md). SEAD-EVENT-0: [`phase_m_sead_event0_compaction_results.md`](../tests/phase_m_sead_event0_compaction_results.md). SEAD-PIPE-0: [`phase_m_sead_pipe0_observer_event_pipeline_results.md`](../tests/phase_m_sead_pipe0_observer_event_pipeline_results.md). SEAD-EVENT-1: [`phase_m_sead_event1_code_bucketing_results.md`](../tests/phase_m_sead_event1_code_bucketing_results.md). SEAD-EVENT-2: [`phase_m_sead_event2_bucket_reductions_results.md`](../tests/phase_m_sead_event2_bucket_reductions_results.md). SEAD-ACT-0: [`phase_m_sead_act0_numeric_proposals_results.md`](../tests/phase_m_sead_act0_numeric_proposals_results.md). SEAD-ACT-1: [`phase_m_sead_act1_phase_e_proposal_consumer_results.md`](../tests/phase_m_sead_act1_phase_e_proposal_consumer_results.md). SEAD-ACT-2: [`phase_m_sead_act2_proposal_admission_records_results.md`](../tests/phase_m_sead_act2_proposal_admission_records_results.md). **SEAD-ACT-2 landed:** default-off/test-only fixture-local proposal admission records consume ACT-1 numeric proposal summaries and emit exact admission records under fixed integer threshold/overflow contracts. No CPU planner, scheduler/cache, default wiring, semantic WGSL, simthing-sim semantics, or production bridge. F artifact hash `e2e9e27601ee2e13`. **Chartered with a V1 closure boundary (2026-05-30): stop the ACT-N ladder; consolidate OBS+EVENT+PIPE+ACT into "SEAD Self-AI Proposal Pipeline V1"; proposals route through the real Resource Flow allocator + Threshold/EmitEvent, never a parallel fixture economy — [`sead_self_ai_track.md`](sead_self_ai_track.md).** |
| **Frontier V1 — named closing scenario (M + E)** | **T2** | **named (2026-05-30); integration pending** | Single-theater strategic vertical that closes Phase M and Phase E on accepted substrates: one ≤32×32 grid (first-slice mapping, no atlas/mask), two flat-star depth-2 faction economies (FlatStarResourceFlow, no nested E-11B), mobile cohorts self-directing on the field via exact F-magnitude + SEAD self-AI, commitments via Threshold/EmitEvent. One opt-in `FrontierV1` profile, **default Disabled**. Bounded economy↔field + proposal→action relaxation authorized for this scenario only; hard guardrails intact. Closes E at flat-star; nested/atlas/perception/D-2a stay deferred. First ClauseThing target (parked). Charter + closure plan: [`sead_self_ai_track.md`](sead_self_ai_track.md). |
