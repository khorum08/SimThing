...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-MAG-0 R1 landed** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-PROMOTE-0: [`phase_m_jit_sqrt_promote0_descriptor_admission_results.md`](../tests/phase_m_jit_sqrt_promote0_descriptor_admission_results.md). SQRT-MAG-0: [`phase_m_jit_sqrt_mag0_f_exact_magnitude_results.md`](../tests/phase_m_jit_sqrt_mag0_f_exact_magnitude_results.md). SQRT-MAG-0 R1: [`phase_m_jit_sqrt_mag0_r1_presqrt_contract_results.md`](../tests/phase_m_jit_sqrt_mag0_r1_presqrt_contract_results.md). **SQRT-MAG-0 R1 clarified the pre-sqrt exactness contract:** artifact-backed F sqrt is exact, and F-backed magnitude is exact-authoritative only when its pre-sqrt mag2 input is exact-authoritative/pinned. Raw dx/dy multiply-add magnitude remains a benchmark/probe until exact mag2 construction is proven. F artifact hash `e2e9e27601ee2e13`. No default runtime wiring/scheduler/cache/bridge. |
