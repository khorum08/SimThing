...
- **`RUNTIME-0080-0-R1` OPEN (`RUNTIME-0080-0-R1-DESIGN-0`, 2026-06-05, Opus):** substrate primitive **`GPU-STATE-AUTH-0`** — GPU-resident world state as the input authority for tick N+1. First IMPL sub-rung **`R1a`** = resident double-buffered next-tick authority for **Tier-A field columns** (disruption/location_status/stockpiles/construction_progress/`num_ships` value/blockade-divert/R4 mag); **Tier-B** structural ops via GPU-written **event journal** drained by a bounded CPU **boundary-maintenance** pass (boundaryEvent dispatch, not a planner); CPU shadow retained as parity witness; tick boundary = save/pause/stable-state. No new op/WGSL/atlas-batching/M-4A/invariant edit. Spec: [`../production_paths/runtime_0080_0_r1_next_tick_authority_spec.md`](../production_paths/runtime_0080_0_r1_next_tick_authority_spec.md). Recipient: Cursor/Codex5.5max. **Next:** R1a → R1b (`RESIDENT-EVENTLOG-0`) → R1c (`RESIDENT-REENROLL-0`, behind §11/free-list-scatter stop-lines). **Parked horizon:** multi-atlas/M-4A (§11 gate), richer emergence (`SCENARIO-0080-3`), multi-faction ECON, recursion.
