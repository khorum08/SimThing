...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-EXACT-2E landed (integer bit-IO probe)** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-EXACT-0: [`phase_m_jit_sqrt_exact_candidate_battery_results.md`](../tests/phase_m_jit_sqrt_exact_candidate_battery_results.md). SQRT-EXACT-1D: [`phase_m_jit_sqrt_exact1d_candidate_d_results.md`](../tests/phase_m_jit_sqrt_exact1d_candidate_d_results.md). SQRT-EXACT-1D-R1: [`phase_m_jit_sqrt_exact1d_r1_verbatim_wgsl_results.md`](../tests/phase_m_jit_sqrt_exact1d_r1_verbatim_wgsl_results.md). SQRT-EXACT-2E: [`phase_m_jit_sqrt_exact2e_integer_candidate_results.md`](../tests/phase_m_jit_sqrt_exact2e_integer_candidate_results.md). E (`CorrectlyRoundedIntegerOnly`) uses verbatim WGSL + `u32` bit IO; removes D-style subnormal flush but is `RejectedDeferred` on dense normal accuracy; D remains `ApproximateJitOnly`; C/f64 rejected; A legacy dead; B fallback. Native sqrt remains `ApproximateJitOnly`. M-JIT closure unchanged. |
