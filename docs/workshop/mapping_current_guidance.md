...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-PROMOTE-0 landed** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-EXACT-5F: [`phase_m_jit_sqrt_exact5f_exhaustive_sweep_results.md`](../tests/phase_m_jit_sqrt_exact5f_exhaustive_sweep_results.md). SQRT-PROMOTE-0: [`phase_m_jit_sqrt_promote0_descriptor_admission_results.md`](../tests/phase_m_jit_sqrt_promote0_descriptor_admission_results.md). **SQRT-PROMOTE-0 landed:** artifact-backed Candidate F descriptor/admission is `ExactDeterministic`; native/raw sqrt remains `ApproximateJitOnly`; `mag2` remains blocked as exact input unless routed through exact F; E3 remains exact fallback/reference. F artifact: hash `e2e9e27601ee2e13`, entry `sqrt_cr_f_bits`, `u32` bit IO. No default runtime wiring/scheduler/cache/bridge. Prior slice reports (SQRT-EXACT-0..5F) unchanged. D remains `ApproximateJitOnly`; C/f64 rejected. M-JIT closure unchanged. |
