...
| **Shader/software deterministic sqrt / SEAD observer** | **T2** | **SEAD-OBS-1 landed** | SQRT-MAG2-PERF-0: [`phase_m_jit_sqrt_mag2_perf0_fixed_hotpath_results.md`](../tests/phase_m_jit_sqrt_mag2_perf0_fixed_hotpath_results.md). SEAD-OBS-0: [`phase_m_sead_obs0_mobile_overlay_score_results.md`](../tests/phase_m_sead_obs0_mobile_overlay_score_results.md). SEAD-OBS-1: [`phase_m_sead_obs1_overlay_score_admission_results.md`](../tests/phase_m_sead_obs1_overlay_score_admission_results.md). **SEAD-OBS-1 landed:** default-off descriptor/admission now represents the mobile observer overlay score row. mag2/mag remain exact under Q16.16 + F; score remains ApproximateDiagnostic under f32 weighting. No scheduler/cache/default wiring/production bridge. F artifact hash `e2e9e27601ee2e13`. |
