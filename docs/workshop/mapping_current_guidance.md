...
- **RUNTIME-0080-RR-0 [PASS]:** recursive galaxy→system→planet-surface world + CPU oracle (`runtime_0080_rr_0.rs`); 100-tick recursive CPU oracle; Scope Ledger rows 1–19 implemented; report [`../tests/runtime_0080_rr_0_results.md`](../tests/runtime_0080_rr_0_results.md). **Nested GPU residency is RR-1.**
- **Active consumer (`RUNTIME-0080-RR-OPEN-0`):** RR-1 nested sparse residency next (generalize atlas_0080_0). Ladder RR-1→RR-4; Scope Ledger per rung. Opening: [`../production_paths/runtime_0080_recursive_rehearsal_opening.md`](../production_paths/runtime_0080_recursive_rehearsal_opening.md). **SUPERSEDES** mis-scoped `RUNTIME-0080-M4A-OPEN-0` (parallel theaters).
