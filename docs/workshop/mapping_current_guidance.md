...
| **Frontier V2 — multi-tick closed-loop consumer** | **T2** | **FrontierV2-0/1/2 landed (fixture/test support only; no phase closure; ClauseThing NotImplemented)** | **FrontierV2-0:** first default-off multi-tick closed-loop consumer fixture. Report: [`phase_m_frontier_v2_0_closed_loop_consumer_results.md`](../tests/phase_m_frontier_v2_0_closed_loop_consumer_results.md). **FrontierV2-1:** closed-loop movement/structural FixtureCandidate evolution across ticks. Report: [`phase_m_frontier_v2_1_candidate_evolution_results.md`](../tests/phase_m_frontier_v2_1_candidate_evolution_results.md). **FrontierV2-2:** fixture-only own-column movement feedback application across ticks. Builds on FrontierV2-1 candidate evolution; movement candidate updates own-column shadow state and feeds next-tick source placement. ClauseThing remains unimplemented; no phase closure declared. Report: [`phase_m_frontier_v2_2_movement_feedback_application_results.md`](../tests/phase_m_frontier_v2_2_movement_feedback_application_results.md). |
