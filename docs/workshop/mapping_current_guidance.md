...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-EXACT-5F landed (F exhaustive proof gate)** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-EXACT-0: [`phase_m_jit_sqrt_exact_candidate_battery_results.md`](../tests/phase_m_jit_sqrt_exact_candidate_battery_results.md). SQRT-EXACT-1D: [`phase_m_jit_sqrt_exact1d_candidate_d_results.md`](../tests/phase_m_jit_sqrt_exact1d_candidate_d_results.md). SQRT-EXACT-1D-R1: [`phase_m_jit_sqrt_exact1d_r1_verbatim_wgsl_results.md`](../tests/phase_m_jit_sqrt_exact1d_r1_verbatim_wgsl_results.md). SQRT-EXACT-2E: [`phase_m_jit_sqrt_exact2e_integer_candidate_results.md`](../tests/phase_m_jit_sqrt_exact2e_integer_candidate_results.md). SQRT-EXACT-3E: [`phase_m_jit_sqrt_exact3e_integer_core_results.md`](../tests/phase_m_jit_sqrt_exact3e_integer_core_results.md). SQRT-EXACT-4E: [`phase_m_jit_sqrt_exact4e_exhaustive_sweep_results.md`](../tests/phase_m_jit_sqrt_exact4e_exhaustive_sweep_results.md). SQRT-EXACT-4F: [`phase_m_jit_sqrt_exact4f_candidate_f_results.md`](../tests/phase_m_jit_sqrt_exact4f_candidate_f_results.md). SQRT-EXACT-5F: [`phase_m_jit_sqrt_exact5f_exhaustive_sweep_results.md`](../tests/phase_m_jit_sqrt_exact5f_exhaustive_sweep_results.md). E (`CorrectlyRoundedIntegerOnly`) remains exact fallback/reference (`ExactDeterministicCandidate`). F (`CorrectlyRoundedHwBitmaskNormalized`) now passes full finite non-negative exhaustive proof (`max_ulp=0`, `flush_count=0`) and is `ExactDeterministicCandidate`; production descriptor/admission promotion remains a separate explicit authorization. D remains `ApproximateJitOnly`; C/f64 rejected; A legacy dead; B fallback. Native sqrt remains `ApproximateJitOnly` until admission flip. Approximate sqrt performance mode remains a separate product-policy gate and is not authorized by this slice. M-JIT closure unchanged. |
