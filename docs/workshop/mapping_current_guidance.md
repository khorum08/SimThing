...
| **M-JIT-0** (generic EvalEML WGSL emission prototype) | **T2** | **landed (test-only)** | deterministic semantic-free WGSL for WeightedAccumulator/Ema; wgpu-compiled; CPU/spec/GPU oracle parity; production JIT caching/cohorting remains separately gated; [`phase_m_jit_evaleml_wgsl_prototype_test_results.md`](../tests/phase_m_jit_evaleml_wgsl_prototype_test_results.md) |
| **M-JIT-SQRT-0** (native WGSL `sqrt` candidate battery) | **T2** | **landed (test-only, approximate; R1 oracle-order correction)** | direct scalar `sqrt` shows non-bit-exact local behavior (max ULP=1); vector magnitude batteries use shader-text-order CPU oracle as primary (`(x*x)+(y*y)` then `sqrt`); FMA/`mul_add` recorded diagnostic-only; overall classified `ApproximateJitOnly`; deterministic production `sqrt` remains blocked; [`phase_m_jit_sqrt_candidate_battery_test_results.md`](../tests/phase_m_jit_sqrt_candidate_battery_test_results.md), R1: [`phase_m_jit_sqrt_candidate_battery_r1_test_results.md`](../tests/phase_m_jit_sqrt_candidate_battery_r1_test_results.md) |
| **M-JIT-GRAD-0** (GPU-resident batched spatial field observer) | **T2** | **landed (test-only; R1 output classification)** | semantic-free observer WGSL; 10,000 observers in 1 dispatch; `dx`/`dy`/descent exact-authoritative; `mag2` approximate/diagnostic on batch corpus (max ULP=1, `ApproximateJitOnly`); no `sqrt`; production observer scheduling/caching separately gated; [`phase_m_jit_grad0_spatial_observer_test_results.md`](../tests/phase_m_jit_grad0_spatial_observer_test_results.md), R1: [`phase_m_jit_grad0_spatial_observer_r1_test_results.md`](../tests/phase_m_jit_grad0_spatial_observer_r1_test_results.md) |
| **M-JIT-GRAD-1** (observer + exact formula fusion) | **T2** | **landed (test-only)** | fused semantic-free WGSL: field sample → `dx`/`dy`/descent → exact-subset score (`fma(w0, descent_x, fma(w1, descent_y, bias))`); 10,000 observers in 1 dispatch; no `mag2` in score; no `sqrt`; production observer scheduling/caching separately gated; [`phase_m_jit_grad1_observer_formula_fusion_test_results.md`](../tests/phase_m_jit_grad1_observer_formula_fusion_test_results.md) |
| **M-JIT-DESC-0** (kernel descriptor / admission manifest) | **T2** | **landed (test-only)** | test-layer descriptors for M-JIT-0/SQRT/GRAD kernels; exact vs approximate output authority explicit; `validate_exact_inputs` rejects approximate outputs as exact inputs; production descriptor registry/scheduler separately gated; [`phase_m_jit_desc0_kernel_descriptor_test_results.md`](../tests/phase_m_jit_desc0_kernel_descriptor_test_results.md) |
| **M-JIT-DESC-1** (spec-layer kernel descriptor admission preview) | **T2** | **landed** | `simthing-spec` `KernelDescriptorSpec` + `validate_kernel_descriptor_admission` / `validate_exact_kernel_inputs`; five landed TestOnly descriptors admit; ProductionCandidate/production_wiring/default-on/semantic names rejected; production descriptor registry/scheduler separately gated; [`phase_m_jit_desc1_kernel_descriptor_admission_test_results.md`](../tests/phase_m_jit_desc1_kernel_descriptor_admission_test_results.md) |
| **M-JIT-DESC-2** (spec-layer kernel graph composition admission preview) | **T2** | **landed** | `KernelGraphSpec` + `validate_kernel_graph_admission`; exact edges admit; approximate/missing/cycle/self-edge/ProductionCandidate reject; no scheduler/cache/GPU dispatch; production descriptor registry/scheduler/cache separately gated; [`phase_m_jit_desc2_kernel_graph_admission_test_results.md`](../tests/phase_m_jit_desc2_kernel_graph_admission_test_results.md) |
| **M-JIT-KEY-0** (deterministic kernel graph identity/cache-key preview) | **T2** | **landed** | `KernelGraphIdentity` + `preview_kernel_graph_identity`; stable canonical text/key under node/edge reorder; admission gate preserved; no runtime cache/scheduler/GPU dispatch; production registry/scheduler/cache separately gated; [`phase_m_jit_key0_kernel_graph_identity_test_results.md`](../tests/phase_m_jit_key0_kernel_graph_identity_test_results.md) |
| **M-JIT-COHORT-0** (deterministic kernel graph cohort grouping preview) | **T2** | **landed (R1 helper fence)** | `KernelGraphRequestSpec` + `preview_kernel_graph_cohorts`; groups by stable key; canonical text preserved; collision guard; public API exposes only normal preview path (R1: [`phase_m_jit_cohort0_r1_collision_helper_fence_test_results.md`](../tests/phase_m_jit_cohort0_r1_collision_helper_fence_test_results.md)); no runtime cache/scheduler/GPU dispatch; production registry/scheduler/cache/JIT dispatch separately gated; [`phase_m_jit_cohort0_kernel_graph_cohort_preview_test_results.md`](../tests/phase_m_jit_cohort0_kernel_graph_cohort_preview_test_results.md) |
| **M-JIT-REG-0** (test-only kernel registry manifest preview) | **T2** | **landed** | `KernelRegistryManifestPreview` + `preview_kernel_registry_manifest`; derives from cohort previews; all entries `TestOnlyPreview`/default-off/no production wiring; no runtime cache/scheduler/GPU dispatch; production registry/scheduler/cache/JIT dispatch separately gated; [`phase_m_jit_reg0_kernel_registry_manifest_test_results.md`](../tests/phase_m_jit_reg0_kernel_registry_manifest_test_results.md) |
| **M-JIT-REG-1** (production-candidate registry admission preview) | **T2** | **landed** | `ProductionCandidatePreview` + `preview_production_candidate_registry_entry`; exact-only/semantic-free canonical gate; mag2/sqrt/ApproximateJitOnly reject; non-dispatching/default-off; production registry/scheduler/cache/JIT dispatch separately gated; [`phase_m_jit_reg1_production_candidate_registry_admission_test_results.md`](../tests/phase_m_jit_reg1_production_candidate_registry_admission_test_results.md) |
| **M-JIT-EXEC-0** (ProductionCandidatePreview-gated execution fixture) | **T2** | **landed** | Default-off test fixture executes REG-1-admitted exact GRAD-1-style path over 10k observers; CPU/GPU oracle parity; mag2/sqrt reject before execution; production registry/scheduler/cache/JIT dispatch separately gated; [`phase_m_jit_exec0_production_candidate_fixture_test_results.md`](../tests/phase_m_jit_exec0_production_candidate_fixture_test_results.md) |
| **M-JIT-EXEC-1** (ProductionCandidatePreview-gated cohort execution fixture) | **T2** | **landed** | Identical exact graph requests cohort into one REG-1-admitted entry; combined 20k-observer batch executes in one test dispatch with per-segment oracle parity; distinct graphs refuse mixed cohort; production registry/scheduler/cache/JIT dispatch separately gated; ClauseThing remains proposal-only; [`phase_m_jit_exec1_cohort_execution_fixture_test_results.md`](../tests/phase_m_jit_exec1_cohort_execution_fixture_test_results.md) |

**Next authorized step:** **M-JIT-EXEC-1 ProductionCandidatePreview-gated cohort execution fixture landed.** Production descriptor registry, scheduler, runtime kernel cache, observer scheduling/caching, and JIT cohort dispatch remain separately gated. ClauseThing remains proposal-only unless separately accepted. `mag2` remains diagnostic-only; native `sqrt` remains `ApproximateJitOnly`. Production exact `sqrt` admission, chained gadget-stack scheduling, automatic snapshot/copy scheduling, and production multi-gadget runtime wiring remain separately gated. Atlas/M-4A, active mask/M-6A, source-mask, dual-output `GradientXY`, and production economy→mapping bridge remain Tier-2/deferred.
