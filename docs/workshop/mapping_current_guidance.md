...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-MAG2-0 landed** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-PROMOTE-0: [`phase_m_jit_sqrt_promote0_descriptor_admission_results.md`](../tests/phase_m_jit_sqrt_promote0_descriptor_admission_results.md). SQRT-MAG-0: [`phase_m_jit_sqrt_mag0_f_exact_magnitude_results.md`](../tests/phase_m_jit_sqrt_mag0_f_exact_magnitude_results.md). SQRT-MAG-0 R1: [`phase_m_jit_sqrt_mag0_r1_presqrt_contract_results.md`](../tests/phase_m_jit_sqrt_mag0_r1_presqrt_contract_results.md). SQRT-MAG2-0: [`phase_m_jit_sqrt_mag2_0_fixed_exact_results.md`](../tests/phase_m_jit_sqrt_mag2_0_fixed_exact_results.md). **SQRT-MAG2-0 landed:** exact fixed-point pre-sqrt mag2 construction is available as a default-off/test-only JIT path; F-backed exact magnitude can now consume exact mag2 bits. Raw f32 dx/dy magnitude remains a probe. F artifact hash `e2e9e27601ee2e13`. No default runtime wiring/scheduler/cache/bridge. |
