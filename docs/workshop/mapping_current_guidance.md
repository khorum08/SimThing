...
| **Shader/software deterministic sqrt** | **T2** | **SQRT-MAG2-PERF-0 landed** | Design note: [`sqrt_candidates.md`](sqrt_candidates.md). SQRT-PROMOTE-0: [`phase_m_jit_sqrt_promote0_descriptor_admission_results.md`](../tests/phase_m_jit_sqrt_promote0_descriptor_admission_results.md). SQRT-MAG-0 / R1 / MAG2-0 reports linked. SQRT-MAG2-PERF-0: [`phase_m_jit_sqrt_mag2_perf0_fixed_hotpath_results.md`](../tests/phase_m_jit_sqrt_mag2_perf0_fixed_hotpath_results.md). **SQRT-MAG2-PERF-0 decomposed exact fixed-point mag2 + F sqrt cost and selected Q16.16 combined single-kernel as the current exact SEAD hot-path candidate.** Exactness remains fixed-point/pinned; raw f32 dx/dy remains probe-only. F artifact hash `e2e9e27601ee2e13`. No default runtime wiring/scheduler/cache/bridge. |
