...
- **`RUNTIME-0080-0 R1c-f` verified:** ZeroCohort is GPU-decided from resident `num_ships`; full production-track battery green (`RUNTIME-0080-0-R1c-f-VERIFY-0`). Proceed to stable 100-tick GPU-forward rehearsal (`RUNTIME-0080-0-R2`) before additional substrate or M-4A. Report: [`../tests/runtime_0080_0_r1c_f_resident_zero_cohort_decision_results.md`](../tests/runtime_0080_0_r1c_f_resident_zero_cohort_decision_results.md). R2 handoff: [`../handoffs/runtime_0080_0_r2_stable_100_tick_rehearsal_opening.md`](../handoffs/runtime_0080_0_r2_stable_100_tick_rehearsal_opening.md).
