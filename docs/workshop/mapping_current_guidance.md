...
| **MOBILITY-SCENARIO-0 — v7.9 mobility/transfer scenario admission packet** | **T2** | **ACCEPTED (MOBILITY-SCENARIO-0-ACCEPT-0, 2026-06-01)** | Bounded first-slice scenario (depth 4, k≤4, 48 cells, 34k soak, narrowed adversarial routing) accepted as the named v7.9 scenario; guardrail rejections wired/tested. Opens only `MOBILITY-AUDIT-0 / owner_band_budget_audit`; ALLOC/REENROLL/IDROUTE/ECON/OWNER stay parked; no runtime gate. Report: [`phase_mobility_scenario0_acceptance_review_results.md`](../tests/phase_mobility_scenario0_acceptance_review_results.md). |
