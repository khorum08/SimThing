...
- **`RUNTIME-0080-0 R1b` PARTIAL:** resident event journal for GPU-emitted structural decisions (`RESIDENT-EVENTLOG-0`); movement/blockade/fusion rows GPU-staged and boundary-consumed without tick-planner rederive; combat/reinforcement/birth journal parity still open. Report: [`../tests/runtime_0080_0_r1b_resident_event_journal_results.md`](../tests/runtime_0080_0_r1b_resident_event_journal_results.md). Resident REENROLL/scatter/compact remains R1c future work.
