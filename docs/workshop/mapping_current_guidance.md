...
> (substrates + RUNTIME-0 + RUNTIME-1A green; RUNTIME-1B GPU pass-graph closed). (Charter:
...
| **MOBILITY-SCENARIO-0 — v7.9 mobility/transfer scenario admission packet** | **T2** | **ACCEPTED; RUNTIME-1A PASS** | Substrate ladder + RUNTIME-0 composition harness + RUNTIME-1A CPU-only production fixture green. GPU pass-graph (RUNTIME-1B) remains closed. Report: [`phase_mobility_runtime1_results.md`](../tests/phase_mobility_runtime1_results.md). |
