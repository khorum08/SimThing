...
- **`RUNTIME-0080-0 R1a` IMPLEMENTED / PASS (`RUNTIME-0080-0-R1a-IMPL-0`, 2026-06-05):** Tier-A **`GPU-STATE-AUTH-0`** resident next-tick authority is implemented for disruption/location_status/stockpiles/construction_progress/existing-slot `num_ships` value/blockade-divert/R4 magnitude. Discriminator holds: `gpu_state_feeds_next_tick=true`, `mirror_dispatch_after_cpu_tick=false`, inter-tick Tier-A uploads `0`, checksum `1bba891c779190a4`, report checksum `29629aefc129a18a`. Report: [`../tests/runtime_0080_0_r1a_next_tick_authority_results.md`](../tests/runtime_0080_0_r1a_next_tick_authority_results.md). **Tier-B** structural ops remain bounded boundary maintenance via event-journal posture, not a CPU planner. **R1b/R1c remain parked/open:** R1b (`RESIDENT-EVENTLOG-0`) → R1c (`RESIDENT-REENROLL-0`, behind §11/free-list-scatter stop-lines). **Parked horizon:** multi-atlas/M-4A (§11 gate), richer emergence (`SCENARIO-0080-3`), multi-faction ECON, recursion.
