...
> accepted FrontierV2 artifact targets are the designer/spec admission substrate. **Next gate (OPEN):
> L2 / `CLAUSE-SPEC-0` — Designer-Facing FrontierV2 Spec Admission** — admit a designer-authored
