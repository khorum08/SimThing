...
| D2f | `TEST-PARE-MAPGENERATOR-ADMISSION-COLLAPSE-0` | Collapse CPU-safe mapgenerator Tier 2 admission fossils under the data-driven edit gate. | **PROBATION** | Six boundary families processed; 37 rows considered, 31 deleted, 6 representatives kept, 0 blocked; exact edited mapgenerator binaries pass locally; targeted Doctrine Exec profile PASS run `28630761735`, failures 0, inspect 0. |
