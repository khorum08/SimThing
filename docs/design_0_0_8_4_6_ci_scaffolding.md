...
| D2e | `TEST-EDIT-SCOPE-GATE-0` | Data-driven Track D test-edit scope gate replacing hardcoded checker exceptions. | **PROBATION** | `scripts/ci/test_edit_scope.tsv` authorizes clausething/spec historical CPU-safe test edit surfaces and DA-approved mapgenerator Tier 2 test surface; prove mode rejects src, kernel/sim, GPU/driver/mapeditor/tools/workshop, and other unauthorized crate edits. |
