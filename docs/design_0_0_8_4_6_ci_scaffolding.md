...
| D2h | `TEST-PARE-BROKEN-CLAUSETHING-ADMISSION-RESIDUE-0` | Delete broken clausething admission duplicates under owner-deep residue ruling. | **PROBATION** | 4 admission rows deleted; representatives proven; inventory 5,671; profile `test-pare-broken-clausething-admission-residue`. |
