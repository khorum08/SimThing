...
| D2j | `TEST-PARE-GPU-BEVY-RESIDUE-0` | Delete Class 2 GPU/Bevy/desktop integration capability-proof relic tests across protected runtime crates under DA-approved temporary tests scope. | **PROBATION** | 274 boundary rows processed; 251 integration tests deleted; 23 Class 1 kept; inventory 5,583 → 5,332; 8 empty test files removed; profile `test-pare-gpu-bevy-residue`; ct_2a/ct_2c compile drift fixed test-only. |
