...
| D2y | `SURFACE-TRUTH-INSPECT-REASON-SPLIT-0` | Split surface-truth INSPECT reporting into match/divergence/tooling-gap. | **PROBATION / DA REVIEW** | CI proof-semantics rung; no source edits; preserves PASS/INSPECT authority while making triage reason machine-readable. |
