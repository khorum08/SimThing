...
| design_0_0_8_6_studio_live_ops.md | 1fe5c149e7af891084b4b73135a44833a6031bb3340a48fad49c14c0bd8f4a15 |
...
| 9.6 | STUDIO-SCENARIO-LIBRARY-CREATE-0 | Create-new / blank or template from library (scope from readiness). | **PROBATION / proof-present** — Create builds a neutral one-cell ScenarioSpec shell, hydrates through `StudioSession:... |
...
Active pointer: `STUDIO-SCENARIO-LIBRARY-CREATE-0`
