...
| design_0_0_8_6_studio_live_ops.md | e70798b5dbcf83f51e382232bd6621389d7dc53a44c1823b82efb00bcf6a02a5 |
...
| 9.7 | STUDIO-LIVE-OPS-CLASS-0 | **Gate-wiring.** Precedented class for live-ops UI + clock shape. | **PROBATION** — class `studio-live-ops-ui-clock` + predicate (priority 40); 12 fixtures clearable + envelope rejects;... |
