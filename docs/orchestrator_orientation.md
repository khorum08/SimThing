...
| design_0_0_8_6_studio_live_ops.md | 345d6aeb15d93a4099be145825c805fe4b42ffc1191e1b94a4286822194de533 |
...
| --- | --- | --- | --- |
| 9.2 | STUDIO-SIM-CLOCK-UI-0 | **Transport UI:** Pause, Play, 2×, 4×, TPS selector; readout (tick index, effect | **DA-GRADUATED / merged [#1283](https://github.com/khorum08/SimThing/pull/1283)** — transport facade over landed `Stu... |
| 9.3 | STUDIO-LIVE-SESSION-BRIDGE-0 | **Wire loaded StudioSession → live tick path** (elevate workshop live-run policy | **PROBATION / PR pending** — clock schedule → SimSession::step_once; JSON multi-tick; STEAD/session identity; no work... |
...
Active pointer: `STUDIO-LIVE-SESSION-BRIDGE-0`
