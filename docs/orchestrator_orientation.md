...
| design_0_0_8_7_rf_arena_modernization.md | 68c64b13ba612a7e95c86055a3fdd2bf3ff1f52f78cb8bc2f1fa5eb83a78479b |
...
- `tp::combat_pirate_ship_0_hull` — uninstantiated combat-enrollment hull host; Phase 8 (8.1-8.2) successor (source_span_token=176)
- `tp::combat_pirate_ship_0_weapon` — uninstantiated combat-enrollment weapon host; Phase 8 (8.1-8.2) successor (source_span_token=193)
- `tp::combat_terran_ship_0_hull` — uninstantiated combat-enrollment hull host; Phase 8 (8.1-8.2) successor (source_span_token=142)
- `tp::combat_terran_ship_0_weapon` — uninstantiated combat-enrollment weapon host; Phase 8 (8.1-8.2) successor (source_span_token=159)
- `tp::hull` — uninstantiated ship-class hull host; Phase 8 (8.1-8.2) successor (source_span_token=91)
- `tp::upkeep` — uninstantiated ship-class upkeep host; Phase 8 (8.1-8.2) successor (source_span_token=125)
- `tp::weapon_damage` — uninstantiated ship-class weapon host; Phase 8 (8.1-8.2) successor (source_span_token=108)
...
| 5.3b | CANONICAL-ANCHOR-MATERIALIZATION-0 | Phase 5: canonical host-materialization from value-placing relations only (econo | census `exact=18/zero=0/conflict=0`; inventory `18/7`; 18 live tp_economy loci; 7 dark; materialization door on `comp... |
...
Active pointer: `CANONICAL-ANCHOR-MATERIALIZATION-0`
