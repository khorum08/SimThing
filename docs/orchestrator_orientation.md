...
| design_0_0_8_6_studio_live_ops.md | 0cfcfdc2dbd22e016ac355a40b9d582891d996698170cd08c190968a856e02f5 |
...
| 12.3 | STUDIO-DISRUPTION-SELECT-SCREEN-0 | **Needs 12.2.** Selecting **any** star (owned, neutral, hostile) screens the **s | **DA-GRADUATED / merged [#1420](https://github.com/khorum08/SimThing/pull/1420) @ `61abf63b`** — DA final ruling `506... |
| 12.5 | STUDIO-FLEET-ICONS-0 | **Needs 12.4.** Tiny ship icon (rocket/destroyer silhouette; **≤75% of the base  | **PROBATION / DRAFT** — branch `coder/studio-fleet-icons-0`; HD-RECEIPT `c88f057a19fc`; Owner icon-base rider binding... |
...
| RF-5 | RF-NEED-WEIGHT-PROFILE-TRANSPORT-0 | **Bounded need/`weight_profile` transport.** Generic binding of hydrated need/we | **DA-GRADUATED / merged [#1414](https://github.com/khorum08/SimThing/pull/1414) @ `da8f7035`** — 2026-07-19. DA rulin... |
| RF-5A | RF-NEED-BINDING-AUTHORING-0 | **Prerequisite authoring surface for RF-5.** Generic scenario-agnostic ClauseScr | **DA-GRADUATED / merged [#1416](https://github.com/khorum08/SimThing/pull/1416) @ `3ad5add3`** — 2026-07-19; DA gradu... |
...
Active pointer: `STUDIO-FLEET-ICONS-0`
