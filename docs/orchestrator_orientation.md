...
| design_0_0_8_6_studio_live_ops.md | 8e5dd9c7921874c86e9e64e9cb6357a7ee400396fb14edf141996a8de312baa4 |
...
| 12.9 | STUDIO-FIELD-SESSION-ELEVATE-0 | **Needs 12.8.** The Studio live bridge opens the **field-bearing session path**  | **PROBATION / GPU remedial proof-present / OWNER replacement OVL OPEN / RF-5 SPLIT APPROVED / DA-HOLD** — prior execu... |
...
| RF-4 | (12.9 resumes) `STUDIO-FIELD-SESSION-ELEVATE-0 | Studio field-bearing consumes the now-executing RF; telemetry binds to the real  | **PROBATION / GPU remedial proof-present / OWNER replacement OVL OPEN / RF-5 SPLIT APPROVED / DA-HOLD** — recursive R... |
