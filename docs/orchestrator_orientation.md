...
| design_0_0_8_6_studio_live_ops.md | f4861443b5c6475148c338e4fc3915ecac1f557837d09ef6a08ea5243b9ce5db |
...
| --- | --- | --- | --- |
| 10.0 | STUDIO-TRANSPORT-OBSERVE-REFINE-0 | Presentation polish of transport + live-observe surface (affordances/layout/shor | **PARKED** — superseded by Phase 11 (concrete UI scope landed 2026-07-11); reopen only if a transport-specific tweak ... |
| 11.1 | STUDIO-CANONICAL-SCENARIO-0 | **Foundation.** Resolve clause `source_json`/includes **relative to the clause f | **PROBATION** PR pending — clause-dir path resolution + portable scenarios + 4 proofs; evidence studio_canonical_scen... |
| 11.2 | STUDIO-FACTION-IDENTITY-FIELDS-0 | Owner/faction identity fields on the scenario spec + clause grammar + hydrate: * | NOT STARTED |
...
| 11.6 | STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0` (needs 11.2) | Selecting a faction-owned star **brightens all stars that faction owns** to refl | NOT STARTED |
| 11.7 | STUDIO-FROSTED-GLASS-0 | Window backgrounds get a real **frosted-glass** effect: slight darkening tint +  | NOT STARTED |

## Next Rung Pointer

Active pointer: `STUDIO-CANONICAL-SCENARIO-0`
