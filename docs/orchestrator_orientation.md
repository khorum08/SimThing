...
| design_0_0_8_5_clausescript_terran_pirate_galaxy.md | 10441cb9921b945e56ec1a83a054c6f68e29e3b75a2b65ea1ab23bce82468df9 |
...
| 8.6 | TP-STUDIO-STEAD-REBIND-0 | Workshop-homed (default): project `AuthorityTreeCandidate` → `StructuralRebindRe | **OPEN — next production pointer.** Exit: workshop rebind helper + tests + results; still no production mapeditor Cla... |

## Next Rung Pointer

Active pointer: `TP-STUDIO-STEAD-REBIND-0`
