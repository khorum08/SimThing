...
| design_0_0_8_6_studio_live_ops.md | 85cc294a9c04b2c43ccf92517d3de852ec4c5d30ec2452d109d1e0c57170cb3e |
...
| 9.3 | STUDIO-LIVE-SESSION-BRIDGE-0 | **Wire loaded StudioSession → live tick path** (elevate workshop live-run policy | **PROBATION / PR #1285** — clock schedule → SimSession::step_once; JSON multi-tick; STEAD/session identity; no worksh... |
