...
| design_0_0_8_4_8_4_1_harness_corrections.md | b8ff296ba2d527e677b185c3368e9ac1d7977a12bf266c5fb1617316512a6e02 |
...
| --- | --- | --- | --- |
| HC-4 | HC-POINTER-DIVERGENCE-LINT-0 | **One truth for the pointer (defect 4).** `gen_orientation.sh --check` FAILs whe | **DA-GRADUATED / merged [#1370](https://github.com/khorum08/SimThing/pull/1370)** — 2026-07-16 (orch=Codex coder=Grok... |
| HC-5 | HC-LADDER-COLUMN-INTEGRITY-0 | **Assert the parser's own invariant (defect 5: silent column shift).** `parse_ru | **PROBATION / proof-present / DA-review-pending** — implementer proof on branch `coder/hc-ladder-column-integrity-0` ... |
...
Active pointer: `HC-LADDER-COLUMN-INTEGRITY-0`
