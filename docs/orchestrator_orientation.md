...
| 5.10 | EML-PRIMITIVE-DOMAIN-0 | **Phase 5 completion — Owner-approved 2026-08-03, anchored by `docs/full_eml_uni | Sealed type lands; an unguarded, uncertified call site is a spanned admission error with a planted-defect red; a clam... |
