...
| design_0_0_8_4_8_4_hd_board.md | db8f03ecacc25733a8c48241e793b4b7cde3d9820f65ec26dceb09572055e521 |
...
| HD-9 | HD-PARK-REDIRECT-0 | **Corrective (Owner-directed 2026-07-15): parked-for-redirection state.** `--par | PROBATION / proof-present / DA-review-pending — `--park` and `--unpark` implemented with transactional rollback fixtu... |
