...
| design_0_0_8_6_studio_live_ops.md | 91faf9130f5f2b157cfeb79db913447ffbdd409d447b3785a18a4f46803939b6 |
...
| 11.6 | STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0 | **Needs 11.2.** Selecting a faction-owned star **brightens all stars that factio | **PROBATION** (PR pending stamp) — owned-set star visual highlight from owner_flow_owner_ref; unowned no group; desel... |
| 11.7 | STUDIO-FROSTED-GLASS-0 | Window backgrounds get a real **frosted-glass** effect: slight darkening tint +  | NOT STARTED |

## Next Rung Pointer

Active pointer: `STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0`
