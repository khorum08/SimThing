...
| design_0_0_8_6_studio_live_ops.md | 868012460c86d1c71e73e3b5bb8474c148486482414e24675949c1c691bbf4e6 |
...
| --- | --- | --- | --- |
| 11.3 | STUDIO-STAR-NAMING-PASS-0 | Galaxy generation runs the **star-naming pass** so every star system carries a d | **DA-GRADUATED / merged [#1304](https://github.com/khorum08/SimThing/pull/1304) @ `052cc192`** — isolated domain-sepa... |
| 11.4 | STUDIO-CLAUSE-LOADER-SIMPLIFY-0 | **Needs 11.1.** Scenario Library shows **only the ClauseScript loader**; the res | **PROBATION** PR pending — ClauseScript-only loader + source_base + Scenario telemetry; evidence studio_clause_loader... |
| 11.5 | STUDIO-FACTION-NAMEPLATES-0 | **Needs 11.2 + 11.3.** Star + planet nameplates render the **star/system name**  | NOT STARTED |
| 11.6 | STUDIO-OWNED-STAR-SELECT-BRIGHTEN-0 | **Needs 11.2.** Selecting a faction-owned star **brightens all stars that factio | NOT STARTED |
| 11.7 | STUDIO-FROSTED-GLASS-0 | Window backgrounds get a real **frosted-glass** effect: slight darkening tint +  | NOT STARTED |

## Next Rung Pointer

Active pointer: `STUDIO-CLAUSE-LOADER-SIMPLIFY-0`
