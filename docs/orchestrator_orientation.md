...
| design_0_0_8_4_7_orchestration_harness.md | 1a9d98e17dc4d63daabad1710520b2002673bf34eea2186ff021ce46abfaafca |
...
| 2b | OH-COLD-START-0` (after 2) | `orient.sh` + `ORIENT-RECEIPT` emission; receipt validation in `relay_lint.sh` | **PROBATION / proof-present / DA-review-pending** — PR pending @ head; `orient.sh` + receipt validation + `/orient` r... |
