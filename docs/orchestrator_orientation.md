...
| design_0_0_8_7_rf_arena_modernization.md | 96d4e8a2fc299ef36d8676009706633f6d851e2fd9e6cb9d7453a3046aeb2bcc |
...
| 2.1 | OVERLAY-EFFECT-HOST-ADMISSION-0 | Phase 2: close the effect-target v0 trap — host placement + `overlay_hosts` admi | **PROBATION / proof-present / DA-review-pending** — missing-property fixture hard-errors with overlay id + resolved h... |
