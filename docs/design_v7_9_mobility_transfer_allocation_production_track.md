...
| RUNTIME-1B-DISPATCH | Real scheduled GPU dispatch of mobility composition (needs mobility shader + scheduled wiring) | MOBILITY-GPU-KERNEL-2 green | **Closed (separate later gate; no default production schedule yet)** | 34k column soak proven; mobility scheduled dispatch still closed |
