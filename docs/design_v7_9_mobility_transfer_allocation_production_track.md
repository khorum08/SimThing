...
| RUNTIME-1B-DISPATCH | Real scheduled GPU dispatch of mobility composition (needs mobility shader + scheduled wiring) | MOBILITY-GPU-KERNEL-3 green | **Closed (separate later gate; no default production schedule yet)** | Composition projection proven; mobility scheduled dispatch still closed |
