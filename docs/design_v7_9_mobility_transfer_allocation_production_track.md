...
| RUNTIME-1B-DISPATCH | Real scheduled GPU dispatch of mobility composition (needs mobility shader + scheduled wiring) | MOBILITY-GPU-KERNEL-0 green | **Closed (separate later gate; no default production schedule yet)** | Column kernel proven; mobility scheduled dispatch still closed |
