...
**Next gate:** depends on [`e11b_nested_dynamic_enrollment_readiness.md`](reviews/e11b_nested_dynamic_enrollment_readiness.md) recommendation: narrow E-11B nested dynamic enrollment (only after product names a scenario), pause E-11B, narrow D-2a only after a named hard-currency scenario, simthing-spec/RON/Designer guardrail rebuild, or continued flat-star soak. Global default-on remains deferred.
