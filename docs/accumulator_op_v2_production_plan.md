...
**Next gate:** RF-T5 scenario-class burn-in / telemetry soak; global default-on remains deferred; or E-11B, D-2a per product priority.
...
| **RF-T5** | — | Scenario-class burn-in / telemetry soak | **Next** |
