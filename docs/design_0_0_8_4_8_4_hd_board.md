...
6. **Exit-proof column ownership (Owner-directed, 2026-07-12).** Ladder graduation stamps
   ...
   encodes this as a DA-audience mutation; until then the live HD-1 guards catch unstamped claims.
