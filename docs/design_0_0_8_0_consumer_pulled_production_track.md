...
> R2 remains single-galactic-tier, opt-in/default-off, CPU-oracle primary; R3-R7 stay unopened. SEAD
> consumption remains deferred to R4. OWNER masked-reduction *runtime* + R3 remain parked. M-4A
