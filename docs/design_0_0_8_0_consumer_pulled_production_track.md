...
>
> **Next horizon:** M-4A / multi-atlas masking and physical resident compaction/lineage rewrite beyond R1c-d staging; `structural_decisions_gpu_emitted` remains future umbrella work
