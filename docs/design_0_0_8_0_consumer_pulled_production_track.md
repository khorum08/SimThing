...
>
> **Next horizon:** resident compaction/lineage rewrite for membership + cohort table behind the §11 / free-list-scatter stop-lines; then multi-atlas batching + M-4A masking
