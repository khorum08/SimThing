...
> claim.** Multi-tier recursive reduce-up + blockade/divert remain deferred to R2; SEAD consumption remains
> deferred to R4. OWNER masked-reduction *runtime* + R3 remain parked. M-4A sparse-residency scheduler and
> REENROLL remain parked. **Next gate: `R2` — OPEN / AUTHORED (2026-06-04)** (recursive allocation +
> faction economy + blockade/divert, single galactic tier; full §12.5 scope, rung-identity boundaries; no
> implementation yet): [`scenarios/scenario_0080_2_r2_recursive_reduce_opening_spec.md`](scenarios/scenario_0080_2_r2_recursive_reduce_opening_spec.md).
>
