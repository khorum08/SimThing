...
| `PRODUCTION-PATH-0080-1` | `SCENARIO-0080-1` opt-in production path | **OPEN WITH NARROWING — opt-in Nested Starmap production path; no implementation** — composes the green `ATLAS-0080-0` (sparse residency) + `ECON-SCALE-0080-0` (faction-index ECON) substrates into the accepted scenario; owner-overlay inheritance + ownership up-aggregation as numeric overlay summaries; read-only SEAD composite-gap terms; **no schedule/movement, no new substrate**. Spec: [`production_paths/production_path_0080_1_opening_spec.md`](production_paths/production_path_0080_1_opening_spec.md); review: [`tests/phase_production_path_0080_1_opening_review_results.md`](tests/phase_production_path_0080_1_opening_review_results.md). |
