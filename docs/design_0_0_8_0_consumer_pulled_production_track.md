...
| `PRODUCTION-PATH-0080-1` | `SCENARIO-0080-1` opt-in production path | **NOT YET OPENED — both substrate gates now IMPLEMENTED/PASS; ready for the design-authority OPEN gate** (rung 3 of the §11 ladder; Opus authors the opening spec) |
