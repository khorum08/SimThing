...
> **Status: CLOSED (2026-07-16, Owner-authorized; CLOSEOUT-RECEIPT c4b6a2886747).** Short corrective track off the HD Board substrate
...
>
> **Why.** Five harness defects (plus audit findings) surfaced in the first post-HD production rung
> (`STUDIO-FLEET-PRESENCE-READOUT-0`, #1355) and in the HD closeout. Each one lets a **false green**
> or **silent cruft** through gates whose entire promise is that green means proven. All were
> mechanical, spanning `scans.tsv`, `gen_orientation.sh`/`track_closeout.sh`, the board workflow, and two
> crate remediations, and were
...
| HC-CLOSEOUT-0 | every rung lands a falsifier that FAILS on the pre-fix tree (prove-the-guard-bites) | discharged (all 8 rungs proved bite pre-fix; row reaped at close) |
