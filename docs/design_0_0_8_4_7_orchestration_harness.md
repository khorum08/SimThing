...
| 2 | `OH-ORIENTATION-DIGEST-0` | `gen_orientation.sh` + generated `docs/orchestrator_orientation.md` + CI freshness gate + `/orient` | **PROBATION / proof-present / DA-review-pending** — PR [#1165](https://github.com/khorum08/SimThing/pull/1165) @ `fcdb194a`; generated `orchestrator_orientation.md` + freshness gate + `/orient` wired; DA clearance required (gate-wiring) |
