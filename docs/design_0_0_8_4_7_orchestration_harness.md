...
> **Status: DA-CLOSED / merged closing rung [#1173](https://github.com/khorum08/SimThing/pull/1173) @ `c189349f9de47bffb0936d67b5c3723c6133e8da`; orchestration harness complete.** Owner-commissioned (Grok/Gemini root-cause studies absorbed,
...
| 4 | `OH-DOCS-SUNSET-0` (closing rung) | Prose compression: every §5A/§1A/§12 paragraph now enforced by M1–M3 replaced with a pointer line; DOC-BUDGET scan row; `rule_expiry_check.sh`; sunset ledger in this doc listing each retired paragraph → enforcing surface | **DA-GRADUATED / merged [#1173](https://github.com/khorum08/SimThing/pull/1173) @ `c189349f9de47bffb0936d67b5c3723c6133e8da`** — mechanized prose retired; DOC-BUDGET and rule-expiry gates live; AGENTS.md pointer-only; Harness Extension Protocol retained; LED-VERDICT: hold — insufficient §5.1-sketch ledger rows; evidence [`oh_docs_sunset_0_results.md`](tests/oh_docs_sunset_0_results.md) |
