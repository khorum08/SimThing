...
| 2b | `OH-COLD-START-0` (after 2) | `orient.sh` + `ORIENT-RECEIPT` emission; receipt validation in `relay_lint.sh` | **PROBATION / proof-present / DA-review-pending** — PR [#1166](https://github.com/khorum08/SimThing/pull/1166) @ `ccaf8f6a`; implementation/proof head `f7c05304`; `orient.sh` + ORIENT-RECEIPT + relay-lint receipt validation + `/orient` receipt output; Doctrine Exec PASS run [28761158306](https://github.com/khorum08/SimThing/actions/runs/28761158306); Doctrine Scan PASS run [28761158315](https://github.com/khorum08/SimThing/actions/runs/28761158315); DA clearance required (gate-wiring) |
