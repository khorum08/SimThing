...
| F | `KERNEL-CLOSEOUT-0` | — | Scope Ledger + perf-parity ledger; consolidate sub-rung docs (one ledger each); **the four mandatory documentation landings below (§2A)**. **Prerequisite:** `KERNEL-CANDIDATE-F-INCRATE-0` (F0) landed. | — | Opus/Owner (DA) | OPEN |
