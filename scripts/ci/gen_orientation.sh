...
EXECUTION_STATUS_TSV = pathlib.Path(
    os.environ.get(
...
def execution_status_counts(path: pathlib.Path) -> dict:
    """Return per-class counts from execution_status_taxonomy.tsv (optional)."""
