...
- Preserve 5.2/5.3/5.3b. Truthfully rename `canonical_tp_gpu_table_matches_25_anchored_0_unobserved` and update `test_inventory.tsv` in lockstep; this authorized rename is not deletion.
